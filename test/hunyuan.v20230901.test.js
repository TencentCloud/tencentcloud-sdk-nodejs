...
it("hunyuan.v20230901.Describe3DSmartTopologyJob", async function () {
    try {
       const data = await client.Describe3DSmartTopologyJob({})
       expect(data).to.be.ok
    } catch(error) {
      expect(error.requestId).to.be.ok
      expect(error.code).to.be.ok
...
it("hunyuan.v20230901.Submit3DSmartTopologyJob", async function () {
    try {
       const data = await client.Submit3DSmartTopologyJob({})
       expect(data).to.be.ok
    } catch(error) {
      expect(error.requestId).to.be.ok
      expect(error.code).to.be.ok
