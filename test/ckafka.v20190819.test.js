...
it("ckafka.v20190819.DescribeCvmInfo", async function () {
    try {
       const data = await client.DescribeCvmInfo({})
       expect(data).to.be.ok
    } catch(error) {
      expect(error.requestId).to.be.ok
      expect(error.code).to.be.ok
...
it("ckafka.v20190819.ModifyRouteSecurityGroups", async function () {
    try {
       const data = await client.ModifyRouteSecurityGroups({})
       expect(data).to.be.ok
    } catch(error) {
      expect(error.requestId).to.be.ok
      expect(error.code).to.be.ok
...
it("ckafka.v20190819.AssociateRoutesSecurityGroup", async function () {
    try {
       const data = await client.AssociateRoutesSecurityGroup({})
       expect(data).to.be.ok
    } catch(error) {
      expect(error.requestId).to.be.ok
      expect(error.code).to.be.ok
...
it("ckafka.v20190819.DisassociateRoutesSecurityGroup", async function () {
    try {
       const data = await client.DisassociateRoutesSecurityGroup({})
       expect(data).to.be.ok
    } catch(error) {
      expect(error.requestId).to.be.ok
      expect(error.code).to.be.ok
...
it("ckafka.v20190819.DeleteInstancePost", async function () {
    try {
       const data = await client.DeleteInstancePost({})
       expect(data).to.be.ok
    } catch(error) {
      expect(error.requestId).to.be.ok
      expect(error.code).to.be.ok
...
it("ckafka.v20190819.DescribeTypeInstances", async function () {
    try {
       const data = await client.DescribeTypeInstances({})
       expect(data).to.be.ok
    } catch(error) {
      expect(error.requestId).to.be.ok
      expect(error.code).to.be.ok
...
it("ckafka.v20190819.DescribeSecurityGroupRoutes", async function () {
    try {
       const data = await client.DescribeSecurityGroupRoutes({})
       expect(data).to.be.ok
    } catch(error) {
      expect(error.requestId).to.be.ok
      expect(error.code).to.be.ok
