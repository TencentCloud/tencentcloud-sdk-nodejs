...
it("antiddos.v20200309.DescribeOverviewDDoSTrend", async function () {
    try {
       const data = await client.DescribeOverviewDDoSTrend({})
       expect(data).to.be.ok
    } catch(error) {
      expect(error.requestId).to.be.ok
      expect(error.code).to.be.ok
...
it("antiddos.v20200309.DescribeOverviewCCTrend", async function () {
    try {
       const data = await client.DescribeOverviewCCTrend({})
       expect(data).to.be.ok
    } catch(error) {
      expect(error.requestId).to.be.ok
      expect(error.code).to.be.ok
...
it("antiddos.v20200309.DescribeOverviewIndex", async function () {
    try {
       const data = await client.DescribeOverviewIndex({})
       expect(data).to.be.ok
    } catch(error) {
      expect(error.requestId).to.be.ok
      expect(error.code).to.be.ok
...
it("antiddos.v20200309.DescribeOverviewAttackTrend", async function () {
    try {
       const data = await client.DescribeOverviewAttackTrend({})
       expect(data).to.be.ok
    } catch(error) {
      expect(error.requestId).to.be.ok
      expect(error.code).to.be.ok
