...
VPC间规则需指定EdgeId。Nat边界规则需指定地域Region与Direction。
   ...
   */
  async DescribeNDRAssetIdentificationList(
    req: DescribeNDRAssetIdentificationListRequest,
    cb?: (error: string, rep: DescribeNDRAssetIdentificationListResponse) => void
  ): Promise<DescribeNDRAssetIdentificationListResponse> {
   ...
   */
  async DescribeNDRAssetIdentificationCursorList(
    req: DescribeNDRAssetIdentificationCursorListRequest,
    cb?: (error: string, rep: DescribeNDRAssetIdentificationCursorListResponse) => void
  ): Promise<DescribeNDRAssetIdentificationCursorListResponse> {
   ...
   */
  async CheckClusterNatFwPreAccess(
    req: CheckClusterNatFwPreAccessRequest,
    cb?: (error: string, rep: CheckClusterNatFwPreAccessResponse) => void
  ): Promise<CheckClusterNatFwPreAccessResponse> {
   ...
   * 删除Nat防火墙Dnat规则
   */
  async DeleteNatFwDnatRule(
    req: DeleteNatFwDnatRuleRequest,
    cb?: (error: string, rep: DeleteNatFwDnatRuleResponse) => void
  ): Promise<DeleteNatFwDnatRuleResponse> {
   ...
   * 获取用户防火墙(组)的ID名称列表
   */
  async DescribeFwGroupIdNames(
    req: DescribeFwGroupIdNamesRequest,
    cb?: (error: string, rep: DescribeFwGroupIdNamesResponse) => void
  ): Promise<DescribeFwGroupIdNamesResponse> {
  ...
  async CreateNatFwDnatRule(
    req: CreateNatFwDnatRuleRequest,
    cb?: (error: string, rep: CreateNatFwDnatRuleResponse) => void
  ): Promise<CreateNatFwDnatRuleResponse> {
   ...
   * 查询NAT CCN防火墙开关配置
   */
  async DescribeNatCcnFwSwitch(
    req: DescribeNatCcnFwSwitchRequest,
    cb?: (error: string, rep: DescribeNatCcnFwSwitchResponse) => void
  ): Promise<DescribeNatCcnFwSwitchResponse> {
   ...
   * 查询内网间访问控制规则的生效范围
   */
  async DescribeVpcAclEdgeRange(
    req: DescribeVpcAclEdgeRangeRequest,
    cb?: (error: string, rep: DescribeVpcAclEdgeRangeResponse) => void
  ): Promise<DescribeVpcAclEdgeRangeResponse> {
   ...
   */
  async ModifyClusterNatFwSwitch(
    req: ModifyClusterNatFwSwitchRequest,
    cb?: (error: string, rep: ModifyClusterNatFwSwitchResponse) => void
  ): Promise<ModifyClusterNatFwSwitchResponse> {
...
批量修改封禁IP、放通IP/域名生效事件
   ...
   * 修改集群防火墙Bypass状态
   */
  async ModifyClusterFwBypass(
    req: ModifyClusterFwBypassRequest,
    cb?: (error: string, rep: ModifyClusterFwBypassResponse) => void
  ): Promise<ModifyClusterFwBypassResponse> {
   ...
   */
  async DescribeSecurityGroupRegionList(
    req?: DescribeSecurityGroupRegionListRequest,
    cb?: (error: string, rep: DescribeSecurityGroupRegionListResponse) => void
  ): Promise<DescribeSecurityGroupRegionListResponse> {
   ...
   * 查询串行防火墙地域带宽分配信息
   */
  async DescribeSerialRegion(
    req?: DescribeSerialRegionRequest,
    cb?: (error: string, rep: DescribeSerialRegionResponse) => void
  ): Promise<DescribeSerialRegionResponse> {
   ...
   */
  async DescribeClusterNatCcnFwSwitchList(
    req: DescribeClusterNatCcnFwSwitchListRequest,
    cb?: (error: string, rep: DescribeClusterNatCcnFwSwitchListResponse) => void
  ): Promise<DescribeClusterNatCcnFwSwitchListResponse> {
   ...
   * IPS规则查询接口新
   */
  async DescribeIpsRuleListNew(
    req: DescribeIpsRuleListNewRequest,
    cb?: (error: string, rep: DescribeIpsRuleListNewResponse) => void
  ): Promise<DescribeIpsRuleListNewResponse> {
   ...
   */
  async DescribeNatFwClusterRegionStatus(
    req: DescribeNatFwClusterRegionStatusRequest,
    cb?: (error: string, rep: DescribeNatFwClusterRegionStatusResponse) => void
  ): Promise<DescribeNatFwClusterRegionStatusResponse> {
  ...
  async OpenClusterNatFwSwitch(
    req: OpenClusterNatFwSwitchRequest,
    cb?: (error: string, rep: OpenClusterNatFwSwitchResponse) => void
  ): Promise<OpenClusterNatFwSwitchResponse> {
   ...
   * 查询nat规则的配额和使用情况
   */
  async DescribeNatRuleScopes(
    req?: DescribeNatRuleScopesRequest,
    cb?: (error: string, rep: DescribeNatRuleScopesResponse) => void
  ): Promise<DescribeNatRuleScopesResponse> {
   ...
   */
  async CheckClusterVpcFwPreAccess(
    req: CheckClusterVpcFwPreAccessRequest,
    cb?: (error: string, rep: CheckClusterVpcFwPreAccessResponse) => void
  ): Promise<CheckClusterVpcFwPreAccessResponse> {
