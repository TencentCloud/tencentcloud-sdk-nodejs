...
import {
  ...
  DescribeReverseShellRegexpWhiteListInfoRequest,
  ...
  DescribeMaliciousConnectionWhiteListRequest,
  ...
  DescribeMaliciousConnectionWhiteListResponse,
  VirusTaskInfo,
  ...
  DescribeImageDenyRuleDetailRequest,
...
查询集群策略审计列表
   ...
   * 查询镜像拦截规则统计
   */
  async DescribeImageDenyRuleSummary(
    req?: DescribeImageDenyRuleSummaryRequest,
    cb?: (error: string, rep: DescribeImageDenyRuleSummaryResponse) => void
  ): Promise<DescribeImageDenyRuleSummaryResponse> {
...
容器网络创建Yaml网络策略并发布任务
   ...
   * 查询恶意外连白名单
   */
  async DescribeMaliciousConnectionWhiteList(
    req: DescribeMaliciousConnectionWhiteListRequest,
    cb?: (error: string, rep: DescribeMaliciousConnectionWhiteListResponse) => void
  ): Promise<DescribeMaliciousConnectionWhiteListResponse> {
   ...
   * 查询镜像拦截事件趋势
   */
  async DescribeImageDenyEventTendency(
    req: DescribeImageDenyEventTendencyRequest,
    cb?: (error: string, rep: DescribeImageDenyEventTendencyResponse) => void
  ): Promise<DescribeImageDenyEventTendencyResponse> {
...
容器网络查询网络策略自动发现任务进度
   ...
   * 查询反弹shell正则白名单列表
   */
  async DescribeReverseShellRegexpWhiteList(
    req: DescribeReverseShellRegexpWhiteListRequest,
    cb?: (error: string, rep: DescribeReverseShellRegexpWhiteListResponse) => void
  ): Promise<DescribeReverseShellRegexpWhiteListResponse> {
   ...
   * 查询恶意外连黑名单
   */
  async DescribeMaliciousConnectionBlackList(
    req: DescribeMaliciousConnectionBlackListRequest,
    cb?: (error: string, rep: DescribeMaliciousConnectionBlackListResponse) => void
  ): Promise<DescribeMaliciousConnectionBlackListResponse> {
...
容器网络查询资产任务进度
   ...
   * 查询镜像拦截规则详情
   */
  async DescribeImageDenyRuleDetail(
    req: DescribeImageDenyRuleDetailRequest,
    cb?: (error: string, rep: DescribeImageDenyRuleDetailResponse) => void
  ): Promise<DescribeImageDenyRuleDetailResponse> {
   ...
   * 查询镜像拦截事件列表
   */
  async DescribeImageDenyEventList(
    req: DescribeImageDenyEventListRequest,
    cb?: (error: string, rep: DescribeImageDenyEventListResponse) => void
  ): Promise<DescribeImageDenyEventListResponse> {
...
容器网络创建网络策略删除任务
   ...
   * 查询镜像拦截事件详情
   */
  async DescribeImageDenyEventDetail(
    req: DescribeImageDenyEventDetailRequest,
    cb?: (error: string, rep: DescribeImageDenyEventDetailResponse) => void
  ): Promise<DescribeImageDenyEventDetailResponse> {
...
容器网络集群下发刷新任务
   ...
   * 查询镜像拦截规则列表
   */
  async DescribeImageDenyRuleList(
    req: DescribeImageDenyRuleListRequest,
    cb?: (error: string, rep: DescribeImageDenyRuleListResponse) => void
  ): Promise<DescribeImageDenyRuleListResponse> {
...
查询集群网络空间标签列表
   ...
   * 查询反弹shell正则白名单详情
   */
  async DescribeReverseShellRegexpWhiteListInfo(
    req: DescribeReverseShellRegexpWhiteListInfoRequest,
    cb?: (error: string, rep: DescribeReverseShellRegexpWhiteListInfoResponse) => void
  ): Promise<DescribeReverseShellRegexpWhiteListInfoResponse> {
