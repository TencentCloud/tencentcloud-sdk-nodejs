...
export class Client extends AbstractClient {
   ...
   */
  async DescribeNatsEipsInternal(
    req: DescribeNatsEipsInternalRequest,
    cb?: (error: string, rep: DescribeNatsEipsInternalResponse) => void
  ): Promise<DescribeNatsEipsInternalResponse> {
