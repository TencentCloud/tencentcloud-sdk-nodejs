...
export class Client extends AbstractClient {
   ...
   * 查询告警列表
   */
  async DescribeSecurityAlarmTableList(
    req: DescribeSecurityAlarmTableListRequest,
    cb?: (error: string, rep: DescribeSecurityAlarmTableListResponse) => void
  ): Promise<DescribeSecurityAlarmTableListResponse> {
