...
class NetworkConfig extends  AbstractModel {
    constructor(){
         ...
         * @type {boolean || null}
         */
        this.EnableInternetInbound = null;

        /**
         * EnableInternetOutbound信息
         * @type {boolean || null}
         */
        this.EnableInternetOutbound = null;

        /**
         * InboundIpAddresses信息
         * @type {Array.<string> || null}
         */
        this.InboundIpAddresses = null;

        /**
         * OutboundIpAddresses信息
         * @type {Array.<string> || null}
         */
        this.OutboundIpAddresses = null;
    ...
    deserialize(params) {
        ...
        this.EnableInternetInbound = 'EnableInternetInbound' in params ? params.EnableInternetInbound : null;
        this.EnableInternetOutbound = 'EnableInternetOutbound' in params ? params.EnableInternetOutbound : null;
        this.InboundIpAddresses = 'InboundIpAddresses' in params ? params.InboundIpAddresses : null;
        this.OutboundIpAddresses = 'OutboundIpAddresses' in params ? params.OutboundIpAddresses : null;
...
class ModifyExclusiveInstanceRequest extends  AbstractModel {
    constructor(){
        ...
        /**
         * 独享实例参数配置
         * @type {Array.<InstanceParameterInput> || null}
         */
    ...
    deserialize(params) {
        ...
        this.InstanceId = 'InstanceId' in params ? params.InstanceId : null;
        this.InstanceName = 'InstanceName' in params ? params.InstanceName : null;
        this.InstanceDescription = 'InstanceDescription' in params ? params.InstanceDescription : null;

        if (params.Parameters) {
            this.Parameters = new Array();
            for (let z in params.Parameters) {
                let obj = new InstanceParameterInput();
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    deserialize(params) {
        ...
        this.Minimum = 'Minimum' in params ? params.Minimum : null;
        this.Maximum = 'Maximum' in params ? params.Maximum : null;
        this.ModifedTime = 'ModifedTime' in params ? params.ModifedTime : null;
        this.ValueString = 'ValueString' in params ? params.ValueString : null;
        this.DefaultValueString = 'DefaultValueString' in params ? params.DefaultValueString : null;
...
注意：此字段可能返回 null，表示取不到有效值。
         ...
         * @type {string || null}
         */
        this.IsolationStartedTime = null;
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    deserialize(params) {
        ...
        if (params.NetworkConfig) {
            let obj = new NetworkConfig();
            obj.deserialize(params.NetworkConfig)
            this.NetworkConfig = obj;
        }
        ...
        if (params.Parameters) {
            this.Parameters = new Array();
            for (let z in params.Parameters) {
                let obj = new ParameterInfo();
                obj.deserialize(params.Parameters[z]);
                this.Parameters.push(obj);
            }
        }
        this.IsolationStartedTime = 'IsolationStartedTime' in params ? params.IsolationStartedTime : null;
        this.CreatedTime = 'CreatedTime' in params ? params.CreatedTime : null;
