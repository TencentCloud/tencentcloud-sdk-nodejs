...
class CdcSize extends  AbstractModel {
    ...
    deserialize(params) {
        ...
        this.DiskAavilable = 'DiskAavilable' in params ? params.DiskAavilable : null;
...
class ModifyDisksChargeTypeRequest extends  AbstractModel {
    ...
    deserialize(params) {
        ...
        this.DiskChargePostpaid = 'DiskChargePostpaid' in params ? params.DiskChargePostpaid : null;
