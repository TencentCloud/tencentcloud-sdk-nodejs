...
import { DescribeWafDataRequest, DescribeCdnDomainLogsResponse, DescribeCdnDomainLogsRequest, ListTopBotDataResponse, DescribeScdnTopDataResponse, ListScdnTopBotDataRequest, UpdateScdnDomainResponse, DescribeBillingDataRequest, DescribeCdnOriginIpRequest, DescribeDiagnoseReportRequest, EnableClsLogTopicResponse, ListClsLogTopicsResponse, VerifyDomainRecordResponse, ListTopCcDataRequest, CreateScdnLogTaskResponse, DescribeScdnIpStrategyResponse, CreateDiagnoseUrlResponse, ListScdnDomainsResponse, CreateScdnLogTaskRequest, ManageClsTopicDomainsRequest, ListClsTopicDomainsRequest, DescribeReportDataRequest, StopCdnDomainRequest, EnableCachesResponse, StartScdnDomainResponse, DisableCachesResponse, DescribeIpStatusResponse, DescribeDistrictIspDataRequest, DeleteScdnDomainResponse, CreateVerifyRecordRequest, PurgePathCacheRequest, DescribeScdnBotDataRequest, DescribePurgeQuotaResponse, DescribeTrafficPackagesRequest, PurgePathCacheResponse, DescribeTopDataRequest, ModifyPurgeFetchTaskStatusRequest, ListTopDDoSDataRequest, DeleteCdnDomainRequest, DescribeEventLogDataRequest, DescribeDomainsResponse, DescribeScdnConfigRequest, DescribeCcDataResponse, UpdatePayTypeResponse, ListScdnTopBotDataResponse, DisableClsLogTopicRequest, CreateScdnFailedLogTaskResponse, AddCdnDomainRequest, DescribePayTypeRequest, DeleteScdnDomainRequest, DescribeCertDomainsResponse, ListScdnDomainsRequest, DisableCachesRequest, AddCLSTopicDomainsResponse, DescribeIpStatusRequest, CreateScdnFailedLogTaskRequest, DescribeCdnOriginIpResponse, SearchClsLogResponse, PushUrlsCacheRequest, DescribeUrlViolationsRequest, DescribeScdnIpStrategyRequest, DescribeIpVisitRequest, DeleteCdnDomainResponse, DeleteClsLogTopicResponse, DescribeCdnIpResponse, UpdateImageConfigRequest, ListTopClsLogDataResponse, ListClsLogTopicsRequest, CreateClsLogTopicRequest, PurgeUrlsCacheRequest, DescribeScdnConfigResponse, DescribePushQuotaRequest, DescribePurgeTasksRequest, CreateDiagnoseUrlRequest, ListTopDataResponse, UpdateDomainConfigResponse, ListDiagnoseReportResponse, DescribeScdnBotRecordsResponse, DescribeCdnDataRequest, DescribeImageConfigResponse, StopScdnDomainRequest, DescribePushQuotaResponse, CreateClsLogTopicResponse, DescribePurgeQuotaRequest, StopScdnDomainResponse, DescribePayTypeResponse, ListTopDataRequest, DuplicateDomainConfigResponse, EnableCachesRequest, DeleteClsLogTopicRequest, VerifyDomainRecordRequest, CreateVerifyRecordResponse, DescribeReportDataResponse, ListClsTopicDomainsResponse, ManageClsTopicDomainsResponse, StartCdnDomainRequest, DescribePushTasksResponse, AddCdnDomainResponse, ModifyPurgeFetchTaskStatusResponse, DisableClsLogTopicResponse, GetDisableRecordsResponse, AddCLSTopicDomainsRequest, DescribeDDoSDataRequest, CreateEdgePackTaskRequest, ListTopClsLogDataRequest, DescribeTrafficPackagesResponse, DescribeMapInfoRequest, GetDisableRecordsRequest, PurgeUrlsCacheResponse, DescribeImageConfigRequest, ListScdnLogTasksResponse, DescribeWafDataResponse, DescribeDiagnoseReportResponse, DescribeEventLogDataResponse, ListTopWafDataResponse, SearchClsLogRequest, UpdateDomainConfigRequest, DescribeCcDataRequest, DescribeDomainsRequest, DescribeScdnBotDataResponse, StartScdnDomainRequest, ListTopWafDataRequest, DescribeCdnDataResponse, UpdateImageConfigResponse, DescribeOriginDataRequest, CreateScdnDomainRequest, DescribeDistrictIspDataResponse, DescribeDomainsConfigResponse, DescribeCdnIpRequest, DescribeIpVisitResponse, DescribeCertDomainsRequest, DescribeDomainsConfigRequest, ListTopDDoSDataResponse, DuplicateDomainConfigRequest, UpdateScdnDomainRequest, UpdatePayTypeRequest, ListDiagnoseReportRequest, DescribeScdnBotRecordsRequest, ListScdnLogTasksRequest, ListTopCcDataResponse, DescribePushTasksRequest, DescribeOriginDataResponse, DescribeMapInfoResponse, CreateScdnDomainResponse, ListTopBotDataRequest, DescribeBillingDataResponse, EnableClsLogTopicRequest, CreateEdgePackTaskResponse, StartCdnDomainResponse, PushUrlsCacheResponse, StopCdnDomainResponse, DescribeUrlViolationsResponse, DescribePurgeTasksResponse, DescribeScdnTopDataRequest, DescribeDDoSDataResponse, DescribeTopDataResponse } from "./cdn_models";
/**
 * cdn client
 * @class
 */
