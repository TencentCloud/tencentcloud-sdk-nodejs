...
import { ScaleOutInstanceResponse, DescribeClusterNodesResponse, SyncPodStateResponse, CreateInstanceResponse, TerminateTasksRequest, ScaleOutInstanceRequest, ModifyResourceScheduleConfigResponse, DescribeInstanceRenewNodesRequest, InquiryPriceRenewInstanceResponse, DescribeJobFlowRequest, InquiryPriceCreateInstanceResponse, DescribeResourceScheduleRequest, RunJobFlowResponse, TerminateInstanceRequest, TerminateInstanceResponse, InquiryPriceUpdateInstanceResponse, DescribeResourceScheduleResponse, ModifyResourceSchedulerRequest, RunJobFlowRequest, DescribeCvmQuotaResponse, DescribeCvmQuotaRequest, DescribeClusterNodesRequest, SyncPodStateRequest, CreateInstanceRequest, DescribeInstancesRequest, InquiryPriceUpdateInstanceRequest, ModifyResourcePoolsRequest, ModifyResourcePoolsResponse, TerminateTasksResponse, DescribeInstancesResponse, InquiryPriceRenewInstanceRequest, InquirePriceRenewEmrResponse, InquiryPriceCreateInstanceRequest, ModifyResourceScheduleConfigRequest, InquiryPriceScaleOutInstanceRequest, InquirePriceRenewEmrRequest, DescribeInstanceRenewNodesResponse, InquiryPriceScaleOutInstanceResponse, ModifyResourceSchedulerResponse, DescribeJobFlowResponse } from "./emr_models";
/**
 * emr client
 * @class
 */
