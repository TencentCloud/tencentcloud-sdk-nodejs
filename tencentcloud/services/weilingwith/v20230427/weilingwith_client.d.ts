...
import { DescribeWorkSpaceBuildingCountAndAreaRequest, DescribeSpaceDeviceRelationListRequest, DescribeAlarmTypeListResponse, DescribeDeviceStatusStatRequest, DescribeVideoLiveStreamResponse, DescribeTenantBuildingCountAndAreaRequest, AddAlarmProcessRecordRequest, DescribeInterfaceListResponse, ModifyDeviceNameResponse, DescribeEdgeApplicationTokenResponse, DescribeWorkspaceListResponse, DescribeModelListResponse, DescribeRuleDetailRequest, BatchCreateDeviceResponse, CreateApplicationTokenResponse, DescribeTenantUserListRequest, StopVideoStreamingResponse, DescribeDeviceStatusListResponse, ModifyDeviceNameRequest, DescribeFileUploadURLResponse, DescribeFileDownloadURLResponse, DescribeRuleDetailResponse, DescribeSpaceInfoByDeviceIdResponse, DescribeApplicationListRequest, DescribeSceneListRequest, DescribeDeviceListRequest, DescribeSpaceRelationByDeviceIdRequest, ChangeAlarmStatusResponse, DescribeBuildingModelResponse, BatchReportAppMessageResponse, DescribeElementProfilePageRequest, DescribePropertyListResponse, DescribeApplicationListResponse, DescribeFileDownloadURLRequest, StopVideoStreamingRequest, DescribeSpaceTypeListRequest, DescribeModelListRequest, DescribeBuildingListResponse, DescribeWorkspaceUserListResponse, DescribePropertyListRequest, DescribeProductListRequest, ControlCameraPTZResponse, DescribeWorkspaceListRequest, DescribeDeviceTypeListResponse, DescribeVideoRecordStreamResponse, DescribeAlarmLevelListRequest, BatchReportAppMessageRequest, DescribeDeviceStatusStatResponse, DescribeBuildingModelRequest, AddAlarmProcessRecordResponse, DescribeSpaceDeviceIdListResponse, DescribeElementProfileTreeResponse, DescribeTenantDepartmentListRequest, DescribeBuildingProfileRequest, DescribeDeviceShadowListResponse, DescribeBuildingListRequest, DescribeWorkspaceUserListRequest, DescribeVideoCloudRecordResponse, DescribeSpaceDeviceRelationListResponse, UpdateWorkspaceParkAttributesRequest, DescribeLinkRuleListResponse, DescribeSpaceTypeListResponse, ControlDeviceRequest, DescribeAlarmLevelListResponse, DescribeCityWorkspaceListRequest, DescribeDeviceTagListResponse, DescribeActionListResponse, BatchCreateDeviceRequest, BatchKillAlarmRequest, DescribeElementProfileTreeRequest, DescribeLinkRuleListRequest, DescribeEventListResponse, DescribeDeviceTagListRequest, DescribeBuildingProfileResponse, ReportAppMessageRequest, DescribeFileUploadURLRequest, DescribeDeviceStatusListRequest, DescribeVideoCloudRecordRequest, DescribeAdministrationByTagRequest, DescribeCityWorkspaceListResponse, ControlDeviceResponse, DescribeAlarmListResponse, DescribeSpaceRelationByDeviceIdResponse, ControlCameraPTZRequest, DescribeSpaceInfoByDeviceIdRequest, DescribeInterfaceListRequest, DescribeProductListResponse, DescribeVideoRecordStreamRequest, DescribeAlarmStatusListResponse, CreateApplicationTokenRequest, DescribeAlarmStatusListRequest, UpdateWorkspaceParkAttributesResponse, DescribeTenantDepartmentListResponse, DescribeWorkSpaceBuildingCountAndAreaResponse, ReportAppMessageResponse, DescribeAlarmListRequest, DescribeAdministrationByTagResponse, BatchKillAlarmResponse, DescribeDeviceTypeListRequest, DescribeDeviceShadowListRequest, DescribeSceneListResponse, DescribeDeviceListResponse, DescribeTenantBuildingCountAndAreaResponse, DescribeVideoLiveStreamRequest, ChangeAlarmStatusRequest, DescribeAlarmTypeListRequest, DescribeCameraExtendInfoResponse, DescribeCameraExtendInfoRequest, DescribeTenantUserListResponse, DescribeEventListRequest, DescribeElementProfilePageResponse, DescribeSpaceDeviceIdListRequest, DescribeActionListRequest, DescribeEdgeApplicationTokenRequest } from "./weilingwith_models";
/**
 * weilingwith client
 * @class
 */
