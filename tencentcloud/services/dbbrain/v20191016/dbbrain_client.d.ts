...
import { DescribeSlowLogUserHostStatsRequest, DescribeSlowLogTimeSeriesStatsRequest, DescribeTopSpaceSchemasResponse, DescribeTopSpaceTableTimeSeriesResponse, CreateSchedulerMailProfileRequest, DescribeHealthScoreResponse, DescribeDBDiagHistoryResponse, DescribeDiagDBInstancesRequest, DescribeDBSpaceStatusRequest, DescribeAllUserContactResponse, DescribeTopSpaceSchemasRequest, ModifyDiagDBInstanceConfRequest, CreateDBDiagReportTaskRequest, DescribeSecurityAuditLogDownloadUrlsRequest, DescribeSecurityAuditLogExportTasksRequest, AddUserContactRequest, DescribeAllUserGroupResponse, CreateMailProfileResponse, DescribeTopSpaceTablesRequest, DescribeAllUserContactRequest, DescribeDBDiagEventRequest, CreateSecurityAuditLogExportTaskRequest, DescribeDBSpaceStatusResponse, DescribeDBDiagEventResponse, DescribeDBDiagHistoryRequest, DescribeSlowLogUserHostStatsResponse, DescribeDBDiagReportTasksResponse, AddUserContactResponse, DescribeDBDiagReportTasksRequest, CreateDBDiagReportTaskResponse, ModifyDiagDBInstanceConfResponse, CreateDBDiagReportUrlResponse, DescribeTopSpaceSchemaTimeSeriesResponse, DeleteSecurityAuditLogExportTasksRequest, CreateSchedulerMailProfileResponse, DescribeSlowLogTopSqlsResponse, CreateMailProfileRequest, DescribeTopSpaceSchemaTimeSeriesRequest, DescribeTopSpaceTableTimeSeriesRequest, DescribeSlowLogTopSqlsRequest, DescribeMailProfileResponse, DescribeSecurityAuditLogDownloadUrlsResponse, DescribeMailProfileRequest, DescribeHealthScoreRequest, DeleteSecurityAuditLogExportTasksResponse, DescribeDiagDBInstancesResponse, DescribeAllUserGroupRequest, CreateDBDiagReportUrlRequest, DescribeSlowLogTimeSeriesStatsResponse, DescribeSecurityAuditLogExportTasksResponse, CreateSecurityAuditLogExportTaskResponse, DescribeTopSpaceTablesResponse } from "./dbbrain_models";
/**
 * dbbrain client
 * @class
 */
