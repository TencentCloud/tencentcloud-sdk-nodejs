...
export declare class Client extends AbstractClient {
  ...
  * 如果参数为空，返回指定地域的所有实例机型配置。
     ...
     * 查询用户可购买的竞价机型信息列表
     */
    DescribeSpotTypeConfig(req?: DescribeSpotTypeConfigRequest, cb?: (error: string, rep: DescribeSpotTypeConfigResponse) => void): Promise<DescribeSpotTypeConfigResponse>;
}
