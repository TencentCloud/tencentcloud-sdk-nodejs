...
import { SetVocabStateResponse, CreateCustomizationResponse, VoicePrintDeleteRequest, DescribeAsyncRecognitionTasksRequest, ModifyCustomizationStateRequest, GetAsrKeyWordLibListResponse, VoicePrintEnrollResponse, VoicePrintUpdateRequest, CreateAsrKeyWordLibResponse, CreateAsyncRecognitionTaskRequest, GetModelInfoRequest, GetAsrVocabRequest, DescribeTaskStatusResponse, SentenceRecognitionRequest, CloseAsyncRecognitionTaskResponse, CreateCustomizationRequest, DownloadAsrVocabResponse, CreateRecTaskResponse, UpdateAsrKeyWordLibRequest, ModifyCustomizationResponse, DeleteAsrKeyWordLibResponse, DeleteAsrVocabResponse, CreateAsyncRecognitionTaskResponse, VoicePrintDeleteResponse, GetAsrKeyWordLibListRequest, CreateAsrKeyWordLibRequest, DownloadCustomizationResponse, CreateRecTaskRequest, VoicePrintGroupVerifyRequest, GetAsrVocabResponse, GetAsrVocabListRequest, GetCustomizationListResponse, VoicePrintGroupVerifyResponse, DownloadAsrVocabRequest, SetVocabStateRequest, CloseAsyncRecognitionTaskRequest, VoicePrintVerifyRequest, ModifyCustomizationRequest, DeleteCustomizationResponse, DeleteAsrVocabRequest, GetCustomizationListRequest, UpdateAsrVocabResponse, VoicePrintCountResponse, VoicePrintVerifyResponse, DescribeTaskStatusRequest, CreateAsrVocabRequest, GetModelInfoResponse, UpdateAsrVocabRequest, VoicePrintCountRequest, VoicePrintEnrollRequest, CreateAsrVocabResponse, SentenceRecognitionResponse, VoicePrintUpdateResponse, DeleteAsrKeyWordLibRequest, UpdateAsrKeyWordLibResponse, VoicePrintCompareRequest, VoicePrintCompareResponse, DeleteCustomizationRequest, ModifyCustomizationStateResponse, DescribeAsyncRecognitionTasksResponse, GetAsrVocabListResponse, DownloadCustomizationRequest } from "./asr_models";
/**
 * asr client
 * @class
 */
