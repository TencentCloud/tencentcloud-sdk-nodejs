...
import { DeleteComputeEnvResponse, SubmitJobRequest, RetryJobsResponse, TerminateComputeNodeRequest, DescribeTaskLogsRequest, DescribeTaskTemplatesRequest, TerminateComputeNodesResponse, DescribeComputeEnvActivitiesResponse, DescribeComputeEnvResponse, DescribeCpmOsInfoResponse, TerminateJobRequest, DetachInstancesResponse, AttachInstancesResponse, TerminateComputeNodesRequest, DescribeComputeEnvActivitiesRequest, CreateTaskTemplateRequest, DeleteComputeEnvRequest, CreateComputeEnvRequest, DescribeComputeEnvCreateInfoResponse, TerminateJobResponse, DescribeComputeEnvCreateInfosRequest, DescribeComputeEnvRequest, DescribeTaskTemplatesResponse, CreateCpmComputeEnvResponse, DeleteJobRequest, CreateCpmComputeEnvRequest, DescribeTaskLogsResponse, DeleteTaskTemplatesRequest, DescribeJobResponse, DescribeComputeEnvCreateInfoRequest, ModifyTaskTemplateRequest, DescribeCpmOsInfoRequest, DeleteJobResponse, DetachInstancesRequest, DescribeJobSubmitInfoResponse, DescribeComputeEnvCreateInfosResponse, DescribeJobRequest, DescribeInstanceCategoriesResponse, ModifyTaskTemplateResponse, SubmitJobResponse, DescribeJobSubmitInfoRequest, CreateComputeEnvResponse, ModifyComputeEnvResponse, CreateTaskTemplateResponse, DescribeJobsRequest, DeleteTaskTemplatesResponse, DescribeCvmZoneInstanceConfigInfosRequest, TerminateTaskInstanceRequest, TerminateTaskInstanceResponse, RetryJobsRequest, DescribeAvailableCvmInstanceTypesResponse, DescribeTaskResponse, DescribeComputeEnvsResponse, DescribeTaskRequest, AttachInstancesRequest, DescribeComputeEnvsRequest, DescribeCvmZoneInstanceConfigInfosResponse, DescribeJobsResponse, TerminateComputeNodeResponse, DescribeAvailableCvmInstanceTypesRequest, DescribeInstanceCategoriesRequest, ModifyComputeEnvRequest } from "./batch_models";
/**
 * batch client
 * @class
 */
...
待删除的作业必须处于完结状态，且其内部包含的所有任务实例也必须处于完结状态，否则会禁止操作。完结状态，是指处于 SUCCEED 或 FAILED 状态。
     ...
     */
    DescribeCpmOsInfo(req: DescribeCpmOsInfoRequest, cb?: (error: string, rep: DescribeCpmOsInfoResponse) => void): Promise<DescribeCpmOsInfoResponse>;
    /**
     * 用于查看计算环境列表
     */
