...
import { ModifyInstanceResponse, DestroyInstanceResponse, DescribeSlowQueryRecordsDownloadRequest, ResizeDiskRequest, RestartClusterForNodeResponse, DescribeInstanceNodesResponse, DescribeInstanceStateRequest, DescribeClusterConfigsResponse, ScaleOutInstanceResponse, DescribeInstanceNodesRequest, ModifyInstanceRequest, CreateInstanceNewResponse, DescribeSlowQueryRecordsDownloadResponse, DestroyInstanceRequest, CreateInstanceNewRequest, DescribeInstancesResponse, DescribeInstancesRequest, DescribeSlowQueryRecordsRequest, DescribeClusterConfigsRequest, ResizeDiskResponse, ScaleOutInstanceRequest, DescribeSlowQueryRecordsResponse, DescribeDatabaseAuditRecordsResponse, DescribeInstanceResponse, ScaleUpInstanceRequest, RestartClusterForNodeRequest, DescribeInstanceRequest, DescribeInstanceStateResponse, DescribeDatabaseAuditRecordsRequest, DescribeInstanceNodesInfoRequest, DescribeDatabaseAuditDownloadResponse, DescribeDatabaseAuditDownloadRequest, DescribeInstanceNodesInfoResponse, ScaleUpInstanceResponse } from "./cdwdoris_models";
/**
 * cdwdoris client
 * @class
 */
