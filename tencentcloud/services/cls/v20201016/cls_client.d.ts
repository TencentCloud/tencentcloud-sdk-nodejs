...
API返回数据包最大49MB，建议启用 gzip 压缩（HTTP Request Header Accept-Encoding:gzip）。
     ...
     * 本接口用于获取kafka用户信息
     */
    DescribeKafkaUser(req: DescribeKafkaUserRequest, cb?: (error: string, rep: DescribeKafkaUserResponse) => void): Promise<DescribeKafkaUserResponse>;
    /**
     * 本接口用于修改日志主题。
     */
