...
import { DeleteRewriteRequest, DescribeTargetGroupListResponse, DescribeQuotaRequest, DescribeTargetGroupListRequest, BatchDeregisterTargetsResponse, SetLoadBalancerSecurityGroupsResponse, BatchModifyTargetWeightResponse, SetSecurityGroupForLoadbalancersRequest, CreateLoadBalancerRequest, DeleteRuleRequest, DisassociateTargetGroupsResponse, SetLoadBalancerClsLogResponse, ModifyRuleRequest, DescribeClassicalLBByInstanceIdResponse, DescribeBlockIPListResponse, DescribeRewriteRequest, CreateRuleResponse, AssociateTargetGroupsRequest, DeregisterTargetsFromClassicalLBRequest, SetSecurityGroupForLoadbalancersResponse, ModifyTargetWeightResponse, DescribeTaskStatusRequest, DescribeRewriteResponse, DescribeTargetGroupInstancesRequest, RegisterTargetGroupInstancesResponse, DescribeTargetsRequest, RegisterTargetsWithClassicalLBResponse, DescribeTargetGroupsResponse, SetLoadBalancerClsLogRequest, DeleteLoadBalancerListenersRequest, ModifyRuleResponse, DescribeClassicalLBTargetsRequest, DescribeListenersResponse, AutoRewriteRequest, DescribeLoadBalancerListByCertIdResponse, ModifyTargetGroupInstancesWeightResponse, DescribeTargetGroupsRequest, DescribeTaskStatusResponse, BatchRegisterTargetsResponse, ModifyLoadBalancerAttributesRequest, DescribeBlockIPListRequest, DescribeClassicalLBHealthStatusResponse, DescribeClsLogSetRequest, ModifyLoadBalancerAttributesResponse, RegisterTargetsWithClassicalLBRequest, ModifyDomainAttributesResponse, ReplaceCertForLoadBalancersResponse, DescribeTargetsResponse, ModifyListenerRequest, DeregisterTargetGroupInstancesResponse, RegisterTargetsRequest, AssociateTargetGroupsResponse, CreateTopicRequest, DeleteListenerRequest, ModifyTargetPortResponse, DescribeLoadBalancersDetailRequest, DescribeClassicalLBByInstanceIdRequest, ManualRewriteResponse, ModifyBlockIPListRequest, ModifyBlockIPListResponse, DescribeClassicalLBHealthStatusRequest, ModifyDomainRequest, CreateClsLogSetResponse, DeleteLoadBalancerRequest, CreateListenerResponse, CreateTargetGroupResponse, CreateLoadBalancerSnatIpsResponse, CreateTopicResponse, CreateRuleRequest, ModifyTargetGroupInstancesPortResponse, BatchDeregisterTargetsRequest, DeregisterTargetGroupInstancesRequest, ManualRewriteRequest, ModifyListenerResponse, DescribeTargetHealthResponse, DescribeTargetGroupInstancesResponse, CreateTargetGroupRequest, CreateListenerRequest, CreateClsLogSetRequest, DisassociateTargetGroupsRequest, ModifyDomainResponse, RegisterTargetsResponse, DeregisterTargetsFromClassicalLBResponse, DescribeLoadBalancersRequest, DeleteLoadBalancerResponse, AutoRewriteResponse, DeregisterTargetsResponse, ModifyTargetWeightRequest, DescribeLoadBalancersDetailResponse, BatchModifyTargetWeightRequest, DeleteRewriteResponse, DescribeLoadBalancerListByCertIdRequest, DescribeTargetHealthRequest, ReplaceCertForLoadBalancersRequest, DeleteRuleResponse, DescribeClsLogSetResponse, ModifyTargetGroupAttributeRequest, ModifyDomainAttributesRequest, DeregisterTargetsRequest, CreateLoadBalancerSnatIpsRequest, ModifyTargetGroupInstancesWeightRequest, DescribeClassicalLBListenersRequest, DeleteTargetGroupsResponse, ModifyTargetGroupInstancesPortRequest, BatchRegisterTargetsRequest, DescribeBlockIPTaskResponse, DescribeClassicalLBListenersResponse, ModifyTargetGroupAttributeResponse, DescribeBlockIPTaskRequest, CreateLoadBalancerResponse, DeleteLoadBalancerListenersResponse, DescribeListenersRequest, DeleteLoadBalancerSnatIpsRequest, SetLoadBalancerSecurityGroupsRequest, DescribeClassicalLBTargetsResponse, ModifyTargetPortRequest, DescribeLoadBalancersResponse, DeleteListenerResponse, DeleteLoadBalancerSnatIpsResponse, DeleteTargetGroupsRequest, DescribeQuotaResponse, RegisterTargetGroupInstancesRequest } from "./clb_models";
/**
 * clb client
 * @class
 */
