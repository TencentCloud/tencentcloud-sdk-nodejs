...
import { QueryInvoiceResponse, ApplyTradeRequest, QueryOutwardOrderResponse, QueryExchangeRateResponse, UploadTaxPaymentRequest, QueryAcctBindingRequest, ModifyMntMbrBindRelateAcctBankCodeRequest, ApplyPayerInfoResponse, RevokeRechargeByThirdPayRequest, QueryTradeRequest, UnifiedOrderResponse, QueryBankWithdrawCashDetailsRequest, QueryCustAcctIdBalanceRequest, QueryPayerInfoResponse, BindAcctRequest, ReviseMbrPropertyRequest, UploadTaxListResponse, MigrateOrderRefundQueryResponse, RevResigterBillSupportWithdrawRequest, CreateInvoiceResponse, CreateOrderRequest, ModifyBindedAccountRequest, QueryBankWithdrawCashDetailsResponse, CreatePayMerchantRequest, ContractOrderRequest, ModifyAgentTaxPaymentInfoResponse, UnbindRelateAcctRequest, QueryAcctInfoListRequest, CreateMerchantRequest, DeleteAgentTaxPaymentInfoRequest, QueryAcctBindingResponse, QueryCommonTransferRechargeResponse, ApplyOutwardOrderResponse, ApplyReWithdrawalResponse, RegisterBillRequest, RevokeRechargeByThirdPayResponse, QueryContractRequest, QueryInvoiceV2Response, BindAccountResponse, CreateAcctRequest, CreateExternalAnchorRequest, CreateAgentTaxPaymentInfosRequest, ConfirmOrderResponse, CloseOrderResponse, ModifyMerchantRequest, CheckAcctRequest, CheckAmountResponse, CreateAgentTaxPaymentInfosResponse, RechargeByThirdPayRequest, RevokeMemberRechargeThirdPayRequest, QueryPayerInfoRequest, QueryMerchantInfoForManagementResponse, CreateTransferBatchResponse, QuerySingleTransactionStatusRequest, DescribeOrderStatusRequest, QueryDownloadBillURLRequest, BindAccountRequest, ModifyMerchantResponse, RefundOrderResponse, QuerySinglePayResponse, QueryCustAcctIdBalanceResponse, CreateExternalAnchorResponse, QueryTradeResponse, DownloadBillResponse, RevokeMemberRechargeThirdPayResponse, CreateRedInvoiceRequest, QueryAcctInfoListResponse, DeleteAgentTaxPaymentInfosRequest, UploadExternalAnchorInfoResponse, QueryTransferBatchRequest, CreateTransferBatchRequest, ExecuteMemberTransactionResponse, BindRelateAcctUnionPayRequest, ConfirmOrderRequest, RefundResponse, QueryAgentTaxPaymentBatchResponse, DeleteAgentTaxPaymentInfosResponse, RegisterBillSupportWithdrawResponse, QueryTransferResultResponse, QueryContractResponse, RegisterBehaviorResponse, QuerySingleTransactionStatusResponse, QueryAcctInfoRequest, DescribeChargeDetailResponse, QueryBankTransactionDetailsResponse, QueryTransferResultRequest, SyncContractDataResponse, QueryMemberTransactionRequest, UploadTaxPaymentResponse, QueryBillDownloadURLResponse, CreateRedInvoiceV2Request, QueryOutwardOrderRequest, QueryMerchantBalanceRequest, CreateAcctResponse, DescribeChargeDetailRequest, BindAcctResponse, CreateOrderResponse, CreateRedInvoiceResponse, QueryMerchantOrderRequest, QueryTransferDetailResponse, UploadExternalAnchorInfoRequest, BindRelateAccReUnionPayRequest, CreateCustAcctIdResponse, QueryMerchantBalanceResponse, QueryAcctInfoResponse, MigrateOrderRefundQueryRequest, QueryAgentTaxPaymentBatchRequest, QueryMerchantRequest, QueryInvoiceV2Request, CreateSinglePayRequest, RegisterBillResponse, WithdrawCashMembershipRequest, ApplyOutwardOrderRequest, CreatePayMerchantResponse, TerminateContractResponse, RechargeByThirdPayResponse, CheckAmountRequest, ApplyReWithdrawalRequest, QueryDownloadBillURLResponse, CreateInvoiceRequest, QueryAnchorContractInfoRequest, TransferSinglePayResponse, QueryMemberBindResponse, CreateCustAcctIdRequest, QueryBankClearResponse, UnBindAcctResponse, MigrateOrderRefundRequest, CreateRedInvoiceV2Response, QueryCommonTransferRechargeRequest, QueryAgentStatementsResponse, RegisterBehaviorRequest, ReviseMbrPropertyResponse, QueryTransferDetailRequest, QueryOrderRequest, CloseOrderRequest, RevResigterBillSupportWithdrawResponse, QueryBalanceResponse, ApplyWithdrawalResponse, RefundOrderRequest, UnBindAcctRequest, TerminateContractRequest, QueryInvoiceRequest, CheckAcctResponse, QueryReconciliationDocumentResponse, QueryApplicationMaterialResponse, QueryExchangeRateRequest, QueryMerchantInfoForManagementRequest, RechargeMemberThirdPayRequest, QueryBillDownloadURLRequest, TransferSinglePayRequest, QuerySmallAmountTransferResponse, ApplyPayerInfoRequest, CreateSinglePayResponse, RefundMemberTransactionResponse, CreateInvoiceV2Response, QueryBankClearRequest, ModifyBindedAccountResponse, ApplyApplicationMaterialResponse, RefundMemberTransactionRequest, QueryBankTransactionDetailsRequest, DownloadBillRequest, QueryRefundRequest, QuerySinglePayRequest, ApplyTradeResponse, RechargeMemberThirdPayResponse, DescribeOrderStatusResponse, WithdrawCashMembershipResponse, QueryApplicationMaterialRequest, CreateMerchantResponse, UnbindRelateAcctResponse, ApplyApplicationMaterialRequest, ModifyAgentTaxPaymentInfoRequest, QuerySmallAmountTransferRequest, BindRelateAcctSmallAmountResponse, RegisterBillSupportWithdrawRequest, ModifyMntMbrBindRelateAcctBankCodeResponse, QueryBalanceRequest, UploadTaxListRequest, ApplyWithdrawalRequest, ExecuteMemberTransactionRequest, BindRelateAcctSmallAmountRequest, QueryRefundResponse, QueryTransferBatchResponse, QueryMemberTransactionResponse, QueryMemberBindRequest, SyncContractDataRequest, QueryAgentStatementsRequest, BindRelateAcctUnionPayResponse, QueryReconciliationDocumentRequest, QueryOrderResponse, UnifiedOrderRequest, MigrateOrderRefundResponse, QueryAnchorContractInfoResponse, DeleteAgentTaxPaymentInfoResponse, RefundRequest, BindRelateAccReUnionPayResponse, ContractOrderResponse, QueryMerchantOrderResponse, QueryMerchantResponse, CreateInvoiceV2Request } from "./cpdp_models";
/**
 * cpdp client
 * @class
 */
