...
import { DescribeTeamsRequest, DeleteProjectRequest, ImportMaterialResponse, DescribeTeamsResponse, DescribeTaskDetailResponse, ExportVideoEditProjectRequest, DeleteMaterialResponse, SearchMaterialRequest, DeleteTeamResponse, RevokeResourceAuthorizationResponse, DescribeTasksResponse, DeleteTeamRequest, ModifyMaterialResponse, FlattenListMediaRequest, ExportVideoByEditorTrackDataRequest, CreateProjectRequest, ModifyMaterialRequest, DescribeTasksRequest, DescribeLoginStatusRequest, DeleteLoginStatusResponse, CreateLinkResponse, ListMediaResponse, SearchMaterialResponse, DescribeJoinTeamsRequest, DeleteMaterialRequest, CreateProjectResponse, DeleteProjectResponse, DeleteClassRequest, CreateLinkRequest, CreateClassRequest, DescribeMaterialsResponse, GrantResourceAuthorizationResponse, ImportMediaToProjectRequest, DescribeClassRequest, MoveClassRequest, DeleteTeamMembersResponse, MoveClassResponse, ImportMediaToProjectResponse, ModifyTeamMemberResponse, DescribeTeamMembersResponse, AddTeamMemberResponse, CreateTeamResponse, ModifyTeamRequest, ModifyTeamMemberRequest, CreateTeamRequest, DescribeResourceAuthorizationRequest, CreateClassResponse, AddTeamMemberRequest, ExportVideoEditProjectResponse, ListMediaRequest, ModifyTeamResponse, DeleteLoginStatusRequest, DeleteTeamMembersRequest, DescribeSharedSpaceResponse, DescribeResourceAuthorizationResponse, FlattenListMediaResponse, DescribeProjectsRequest, DescribeLoginStatusResponse, DescribeJoinTeamsResponse, DescribeTeamMembersRequest, ModifyProjectResponse, RevokeResourceAuthorizationRequest, DescribeTaskDetailRequest, ModifyProjectRequest, DescribeClassResponse, DescribeSharedSpaceRequest, DeleteClassResponse, GrantResourceAuthorizationRequest, ExportVideoByEditorTrackDataResponse, DescribeProjectsResponse, ImportMaterialRequest, DescribeMaterialsRequest } from "./cme_models";
/**
 * cme client
 * @class
 */
