...
根据音视频内容审核模板唯一标识，获取音视频内容审核模板详情列表。返回结果包含符合条件的所有用户自定义模板及[系统预置内容审核模板](https://cloud.tencent.com/document/product/266/33476#.E9.A2.84.E7.BD.AE.E8.A7.86.E9.A2.91.E5.86.85.E5.AE.B9.E5.AE.A1.E6.A0.B8.E6.A8.A1.E6.9D.BF)。
     ...
     * 控制台验证域名归属
     */
    VerifyDomainOwnershipForConsole(req: VerifyDomainOwnershipForConsoleRequest, cb?: (error: string, rep: VerifyDomainOwnershipForConsoleResponse) => void): Promise<VerifyDomainOwnershipForConsoleResponse>;
    /**
     * 删除用户自定义图片处理模板。
     */
