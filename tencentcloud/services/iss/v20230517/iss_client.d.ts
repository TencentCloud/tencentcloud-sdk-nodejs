...
import { UpdateDeviceStatusRequest, ListDevicesRequest, DeleteRecordBackupPlanResponse, ListOrganizationChannelsRequest, AddRecordBackupPlanResponse, DescribeCNAMERequest, ControlRecordTimelineRequest, DeleteOrganizationRequest, CheckDomainResponse, DescribeCNAMEResponse, UpdateOrganizationResponse, ListAITasksResponse, UpdateDeviceOrganizationRequest, UpdateDeviceOrganizationResponse, AddOrganizationResponse, DescribeDeviceRegionResponse, DescribeDomainResponse, DescribeRecordBackupTemplateRequest, ControlDeviceStreamResponse, DeleteRecordRetrieveTaskResponse, DescribeUserDeviceResponse, DeleteRecordPlanResponse, DescribeOrganizationResponse, UpdateUserDeviceRequest, DescribeDeviceChannelResponse, AddRecordBackupTemplateRequest, DeleteAITaskRequest, UpdateGatewayResponse, DescribeRecordRetrieveTaskRequest, DescribeAITaskRequest, RefreshDeviceChannelResponse, DeleteOrganizationResponse, DescribeRecordTemplateRequest, DeleteRecordTemplateRequest, DescribeGatewayResponse, DescribeGatewayRequest, DeleteUserDeviceRequest, AddRecordPlanResponse, ListOrganizationChannelNumbersRequest, UpdateAITaskRequest, UpgradeGatewayResponse, DeleteDomainRequest, ListRecordRetrieveTasksRequest, DeleteRecordPlanRequest, AddRecordTemplateResponse, ListRecordPlansRequest, DescribeAITaskResultRequest, ListAITasksRequest, UpdateRecordPlanRequest, DescribeOrganizationRequest, UpdateAITaskStatusResponse, ControlRecordResponse, AddRecordPlanRequest, ListRecordTemplatesRequest, DescribeVideoDownloadUrlResponse, DescribeRecordPlanResponse, AddRecordRetrieveTaskRequest, DescribeRecordPlanRequest, ControlDevicePresetResponse, ListRecordBackupPlansResponse, DescribeDomainRequest, AddStreamAuthResponse, ListDevicesResponse, DescribeGatewayMonitorRequest, DeleteGatewayRequest, UpdateOrganizationRequest, ListOrganizationChannelNumbersResponse, ListRecordBackupTemplatesResponse, DescribeRecordPlaybackUrlRequest, ListRecordPlansResponse, DescribeRecordTemplateResponse, DescribeAITaskResultResponse, DescribeDevicePresetResponse, UpdateRecordBackupPlanRequest, ControlRecordRequest, ControlDevicePTZResponse, AddUserDeviceRequest, ListRecordBackupPlanDevicesResponse, ControlDevicePTZRequest, DescribeRecordBackupPlanRequest, DescribeRecordBackupPlanResponse, DescribeDeviceChannelRequest, UpdateUserDeviceResponse, DescribeDevicePresetRequest, ListGatewaysResponse, ListRecordPlanDevicesRequest, DescribeGatewayProtocolResponse, DescribeDomainRegionRequest, AddRecordTemplateRequest, DescribeGatewayProtocolRequest, AddAITaskRequest, DescribeVideoDownloadUrlRequest, DescribeGatewayVersionResponse, ListGatewaysRequest, DescribeGatewayVersionRequest, DescribeUserDeviceRequest, DescribeDeviceRegionRequest, RefreshDeviceChannelRequest, DescribeRecordFileRequest, AddStreamAuthRequest, PlayRecordRequest, CheckDomainRequest, UpgradeGatewayRequest, DescribeRecordFileResponse, ControlDevicePresetRequest, ControlDeviceStreamRequest, ListRecordRetrieveTasksResponse, ListRecordBackupPlanDevicesRequest, DeleteDomainResponse, AddRecordRetrieveTaskResponse, DeleteRecordTemplateResponse, ListRecordPlanDevicesResponse, ListRecordTemplatesResponse, DescribeAITaskResponse, UpdateRecordBackupTemplateResponse, ControlRecordTimelineResponse, DeleteRecordRetrieveTaskRequest, UpdateRecordPlanResponse, DeleteRecordBackupPlanRequest, ListRecordBackupTemplatesRequest, AddAITaskResponse, UpdateRecordTemplateRequest, DeleteRecordBackupTemplateRequest, DeleteAITaskResponse, AddRecordBackupTemplateResponse, PlayRecordResponse, DescribeGatewayMonitorResponse, DescribeRecordBackupTemplateResponse, AddUserDeviceResponse, DeleteGatewayResponse, DescribeRecordPlaybackUrlResponse, ListRecordPlanChannelsRequest, ListOrganizationChannelsResponse, UpdateAITaskStatusRequest, UpdateGatewayRequest, UpdateAITaskResponse, DescribeDomainRegionResponse, ListRecordPlanChannelsResponse, AddRecordBackupPlanRequest, ListRecordBackupPlansRequest, UpdateRecordBackupTemplateRequest, UpdateDeviceStatusResponse, DeleteUserDeviceResponse, UpdateRecordBackupPlanResponse, AddOrganizationRequest, DescribeStreamAuthResponse, DeleteRecordBackupTemplateResponse, UpdateRecordTemplateResponse, DescribeRecordRetrieveTaskResponse, DescribeStreamAuthRequest } from "./iss_models";
/**
 * iss client
 * @class
 */
