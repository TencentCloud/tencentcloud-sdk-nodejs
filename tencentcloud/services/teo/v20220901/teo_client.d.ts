...
import { CreatePlanForZoneResponse, DeployConfigGroupVersionRequest, DescribeEnvironmentsRequest, ModifyL4ProxyRulesStatusResponse, DeleteRulesRequest, CheckCnameStatusResponse, DeleteL4ProxyRulesRequest, ModifyZoneResponse, DescribeOriginGroupResponse, DescribeTopL7CacheDataRequest, DeleteApplicationProxyResponse, DescribeZonesRequest, VerifyOwnershipRequest, DeleteSecurityIPGroupResponse, ModifyRuleRequest, DescribePurgeTasksRequest, DescribePrefetchTasksResponse, DeleteApplicationProxyRequest, DescribeConfigGroupVersionDetailResponse, DescribeDDoSAttackDataResponse, DescribeZoneSettingRequest, ModifyL4ProxyStatusResponse, DescribeIdentificationsResponse, ModifySecurityPolicyRequest, DeleteL4ProxyResponse, ModifyApplicationProxyRuleStatusResponse, DescribeL4ProxyResponse, CreateApplicationProxyResponse, ModifyOriginGroupResponse, DeleteAccelerationDomainsRequest, DescribeApplicationProxiesResponse, DescribeL4ProxyRulesResponse, DescribeDeployHistoryRequest, DescribeAvailablePlansRequest, ModifySecurityPolicyResponse, DescribeHostsSettingResponse, ModifyZoneStatusResponse, ModifyZoneRequest, ModifyApplicationProxyStatusResponse, DeleteZoneResponse, CreateRuleResponse, CreatePurgeTaskResponse, DeleteApplicationProxyRuleResponse, ModifyZoneSettingRequest, DescribeRulesResponse, DownloadL4LogsResponse, DescribeOriginProtectionResponse, BindZoneToPlanResponse, DeleteOriginGroupRequest, DescribeBillingDataRequest, ModifyAliasDomainRequest, DescribeAliasDomainsRequest, ModifyHostsCertificateRequest, ModifyApplicationProxyRequest, ModifyAccelerationDomainStatusesResponse, DescribeRulesSettingResponse, BindSecurityTemplateToEntityResponse, ModifyL4ProxyRulesResponse, DescribeDDoSAttackTopDataRequest, DescribeConfigGroupVersionDetailRequest, DownloadL7LogsResponse, DescribeL4ProxyRulesRequest, DescribeRulesRequest, DescribeContentQuotaResponse, DownloadL7LogsRequest, ModifyZoneSettingResponse, DeleteSecurityIPGroupRequest, ModifyL4ProxyRequest, CreateAliasDomainRequest, CreateAliasDomainResponse, DescribeOriginProtectionRequest, CreatePrefetchTaskRequest, DeleteApplicationProxyRuleRequest, BindSharedCNAMEResponse, DescribeTopL7AnalysisDataRequest, DeleteSharedCNAMERequest, DescribeAccelerationDomainsResponse, DescribeTopL7CacheDataResponse, DescribeOverviewL7DataRequest, IdentifyZoneResponse, DeleteSharedCNAMEResponse, ModifyL4ProxyResponse, DeleteL4ProxyRulesResponse, DescribeSecurityTemplateBindingsResponse, ModifyAccelerationDomainResponse, DescribeTimingL7AnalysisDataRequest, CreatePrefetchTaskResponse, DescribeDefaultCertificatesRequest, BindZoneToPlanRequest, CreateZoneRequest, DescribeTimingL7CacheDataRequest, ModifyAliasDomainStatusResponse, ModifyRuleResponse, CreateConfigGroupVersionResponse, DeleteL4ProxyRequest, VerifyOwnershipResponse, DescribeDDoSAttackEventResponse, CreateApplicationProxyRuleRequest, DownloadL4LogsRequest, DescribeDDoSAttackDataRequest, CreateL4ProxyRequest, DescribeTimingL7AnalysisDataResponse, DescribeConfigGroupVersionsResponse, DescribeApplicationProxiesRequest, DescribeContentQuotaRequest, DescribeOverviewL7DataResponse, ModifyHostsCertificateResponse, CreateRuleRequest, ModifyL4ProxyStatusRequest, DescribeEnvironmentsResponse, CreateApplicationProxyRuleResponse, CreatePlanForZoneRequest, ModifyAliasDomainStatusRequest, BindSecurityTemplateToEntityRequest, CreateApplicationProxyRequest, DescribeBillingDataResponse, ModifyL4ProxyRulesStatusRequest, CreateAccelerationDomainResponse, CreateL4ProxyRulesResponse, DescribeTimingL4DataResponse, CreateZoneResponse, ModifyAccelerationDomainRequest, ModifyApplicationProxyResponse, ModifySecurityIPGroupResponse, ModifyOriginGroupRequest, DescribeTimingL7CacheDataResponse, BindSharedCNAMERequest, ModifyApplicationProxyStatusRequest, DeleteOriginGroupResponse, DescribeL4ProxyRequest, DescribeIdentificationsRequest, ModifyZoneStatusRequest, DescribeDefaultCertificatesResponse, CreateOriginGroupResponse, ModifyApplicationProxyRuleStatusRequest, DescribeAliasDomainsResponse, CreateAccelerationDomainRequest, DeleteZoneRequest, DescribeConfigGroupVersionsRequest, DescribeOriginGroupRequest, ModifyApplicationProxyRuleResponse, DescribeZoneSettingResponse, CreateSecurityIPGroupRequest, DeleteRulesResponse, IdentifyZoneRequest, ModifyApplicationProxyRuleRequest, DescribePrefetchTasksRequest, ModifyL4ProxyRulesRequest, DescribeRulesSettingRequest, DescribeZonesResponse, ModifyAliasDomainResponse, DescribeIPRegionResponse, CheckCnameStatusRequest, DeleteAliasDomainRequest, DeleteAccelerationDomainsResponse, DescribeTopL7AnalysisDataResponse, CreatePurgeTaskRequest, CreateConfigGroupVersionRequest, CreateOriginGroupRequest, DescribeTimingL4DataRequest, DescribeHostsSettingRequest, CreateSecurityIPGroupResponse, CreateSharedCNAMEResponse, DescribePurgeTasksResponse, DescribeAvailablePlansResponse, DescribeDDoSAttackEventRequest, ModifySecurityIPGroupRequest, DeployConfigGroupVersionResponse, DescribeSecurityTemplateBindingsRequest, CreateL4ProxyResponse, DescribeDeployHistoryResponse, CreateSharedCNAMERequest, DescribeAccelerationDomainsRequest, CreateL4ProxyRulesRequest, DescribeDDoSAttackTopDataResponse, DeleteAliasDomainResponse, DescribeIPRegionRequest, ModifyAccelerationDomainStatusesRequest } from "./teo_models";
/**
 * teo client
 * @class
 */
