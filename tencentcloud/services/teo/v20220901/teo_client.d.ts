...
import { CreatePlanForZoneResponse, DownloadL7LogsRequest, DescribeSpeedTestingQuotaResponse, DeleteRulesRequest, ModifyDefaultCertificateRequest, DescribeOriginGroupResponse, DescribeWebManagedRulesLogResponse, DescribeTopL7CacheDataRequest, CreateCredentialResponse, DeleteApplicationProxyResponse, DescribeZonesRequest, DescribeLogTopicTasksRequest, CreateCredentialRequest, ModifyRuleRequest, DescribePrefetchTasksResponse, DescribeWebManagedRulesHitRuleDetailRequest, DeleteApplicationProxyRequest, DescribeDDoSAttackDataResponse, ModifySecurityWafGroupPolicyRequest, DescribeZoneSettingRequest, DescribeClientRuleListResponse, DescribeIdentificationsResponse, ModifySecurityPolicyRequest, ModifyApplicationProxyRuleStatusResponse, DescribeClientRuleListRequest, ModifyZoneSettingRequest, CreateApplicationProxyResponse, ModifyOriginGroupResponse, DeleteAccelerationDomainsRequest, ModifyAliasDomainRequest, DescribeAvailablePlansRequest, DescribeSingleL7AnalysisDataRequest, ModifySecurityPolicyResponse, DescribeHostsSettingResponse, ModifyZoneStatusResponse, ModifyZoneResponse, ModifyZoneRequest, ModifyApplicationProxyStatusResponse, DeleteZoneResponse, CreateRuleResponse, CreatePurgeTaskResponse, DeleteApplicationProxyRuleResponse, ReclaimAliasDomainRequest, DescribeRulesResponse, DescribeOriginProtectionResponse, BindZoneToPlanResponse, DeleteOriginGroupRequest, DescribeAliasDomainsRequest, ModifyApplicationProxyStatusRequest, ModifyHostsCertificateRequest, DescribeDnsDataResponse, ModifyAccelerationDomainStatusesResponse, DescribeRulesSettingResponse, DescribeDDoSAttackTopDataRequest, ModifyAccelerationDomainRequest, DescribeRulesRequest, DescribeSpeedTestingMetricDataRequest, ModifyZoneSettingResponse, DescribeZonesResponse, UpdateOriginProtectionIPWhitelistRequest, DescribeSpeedTestingDetailsResponse, CreateAliasDomainRequest, CreateAliasDomainResponse, DescribeOriginProtectionRequest, CreatePrefetchTaskRequest, DeleteApplicationProxyRuleRequest, DescribeApplicationProxiesResponse, DescribeTopL7AnalysisDataRequest, DescribeAccelerationDomainsResponse, ModifyRulePriorityResponse, DescribeTopL7CacheDataResponse, DescribeOverviewL7DataRequest, IdentifyZoneResponse, DescribeWebProtectionTopDataRequest, ModifySecurityWafGroupPolicyResponse, DescribeTimingL7SourceDataResponse, DescribeWebManagedRulesDataRequest, DescribeWebManagedRulesDataResponse, CreateSpeedTestingRequest, ModifyAliasDomainStatusResponse, ModifyRulePriorityRequest, DescribeTimingL7AnalysisDataRequest, CreatePrefetchTaskResponse, DescribeDefaultCertificatesRequest, DescribeAliasDomainsResponse, DescribeWebProtectionHitRuleDetailRequest, CreateZoneRequest, DescribeTimingL7CacheDataRequest, ModifyRuleResponse, CheckCertificateResponse, DescribeLogSetsResponse, DescribeWebProtectionDataRequest, CheckCertificateRequest, DescribeAddableEntityListResponse, CreateApplicationProxyRuleRequest, ModifyApplicationProxyRequest, CreateReplayTaskRequest, DescribeWebProtectionHitRuleDetailResponse, DescribeDDoSAttackDataRequest, DescribeWebProtectionClientIpListResponse, DescribeTimingL7AnalysisDataResponse, ModifyAliasDomainStatusRequest, DescribeApplicationProxiesRequest, DescribeContentQuotaRequest, DescribeOverviewL7DataResponse, ModifyHostsCertificateResponse, CreateRuleRequest, ModifyZoneStatusRequest, CreateApplicationProxyRuleResponse, DescribeLogSetsRequest, CreatePlanForZoneRequest, CreateApplicationProxyRequest, DescribeSpeedTestingMetricDataResponse, CreateAccelerationDomainResponse, DescribeTimingL4DataResponse, CreateZoneResponse, DescribeSpeedTestingQuotaRequest, ModifyApplicationProxyResponse, ReclaimZoneRequest, ModifyOriginGroupRequest, DownloadL4LogsResponse, DescribeTimingL7CacheDataResponse, DescribeAddableEntityListRequest, DescribeSingleL7AnalysisDataResponse, DeleteOriginGroupResponse, DescribeSpeedTestingDetailsRequest, DescribeTimingL7SourceDataRequest, UpdateOriginProtectionIPWhitelistResponse, DescribeIdentificationsRequest, DescribeDefaultCertificatesResponse, CreateOriginGroupResponse, ModifyApplicationProxyRuleStatusRequest, BindZoneToPlanRequest, CreateAccelerationDomainRequest, DeleteZoneRequest, ModifyDefaultCertificateResponse, DescribeTopL7AnalysisDataResponse, DescribeOriginGroupRequest, ModifyApplicationProxyRuleResponse, DescribeZoneSettingResponse, DeleteRulesResponse, DescribeWebProtectionDataResponse, ModifyApplicationProxyRuleRequest, ModifyAccelerationDomainResponse, DescribePrefetchTasksRequest, DescribeRulesSettingRequest, ModifyAliasDomainResponse, DeleteAliasDomainRequest, DescribeContentQuotaResponse, DeleteAccelerationDomainsResponse, DescribeDnsDataRequest, CreatePurgeTaskRequest, DownloadL7LogsResponse, CreateOriginGroupRequest, DescribeTimingL4DataRequest, DescribeHostsSettingRequest, DescribeWebManagedRulesLogRequest, ReclaimZoneResponse, DescribePurgeTasksResponse, DescribeAvailablePlansResponse, DescribePurgeTasksRequest, DescribeWebProtectionTopDataResponse, DescribeWebManagedRulesHitRuleDetailResponse, DescribeWebProtectionClientIpListRequest, IdentifyZoneRequest, DownloadL4LogsRequest, CreateSpeedTestingResponse, DescribeAccelerationDomainsRequest, ReclaimAliasDomainResponse, DescribeDDoSAttackTopDataResponse, DeleteAliasDomainResponse, ModifyAccelerationDomainStatusesRequest, DescribeLogTopicTasksResponse, CreateReplayTaskResponse } from "./teo_models";
/**
 * teo client
 * @class
 */
