...
export declare class Client extends AbstractClient {
     ...
     */
    DescribeHostCertificates(req: DescribeHostCertificatesRequest, cb?: (error: string, rep: DescribeHostCertificatesResponse) => void): Promise<DescribeHostCertificatesResponse>;
    /**
     * 查询应用代理列表。
     */
