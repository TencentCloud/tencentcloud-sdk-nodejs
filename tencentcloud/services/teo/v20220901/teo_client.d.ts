...
import { DescribeOriginGroupResponse, DescribeBotDataRequest, DescribeSingleL7AnalysisDataRequest, DescribeHostsSettingResponse, DescribeRulesResponse, DescribeOriginProtectionResponse, DescribeBotDataResponse, CreateAliasDomainRequest, CreatePrefetchTaskRequest, DescribeApplicationProxiesResponse, DescribeTopL7AnalysisDataRequest, ModifyRulePriorityResponse, IdentifyZoneResponse, DescribeDDoSAttackSourceEventResponse, DescribeAliasDomainsResponse, DescribeTimingL7CacheDataRequest, DescribeSecurityPolicyListResponse, CheckCertificateRequest, DescribeDDoSAttackEventResponse, DescribeWebProtectionClientIpListResponse, DescribeTimingL7AnalysisDataResponse, ModifyDDoSPolicyHostResponse, DescribeSpeedTestingMetricDataResponse, CreateLogSetResponse, DownloadL4LogsRequest, CreateCustomErrorPageRequest, DescribeDnssecResponse, ModifyZoneCnameSpeedUpRequest, ModifyZoneSettingRequest, DescribeDDoSPolicyResponse, CreateApplicationProxyRuleRequest, DescribeDDoSBlockListRequest, DescribeDDoSMajorAttackEventRequest, DescribeSecurityPolicyListRequest, DescribeTimingL7CacheDataResponse, DescribeZonesResponse, DescribeDDoSPolicyRequest, ReclaimZoneRequest, DeleteZoneRequest, ModifyZoneCnameSpeedUpResponse, DescribeRulesSettingRequest, DescribeDnsDataRequest, CreateOriginGroupRequest, DescribeWebManagedRulesLogRequest, DescribeAvailablePlansResponse, DescribeWebProtectionTopDataResponse, DescribeLogTopicTaskDetailResponse, DescribeDDoSAttackTopDataResponse, DescribeDistributionL4AccessDataRequest, DescribeSpeedTestingQuotaResponse, DeleteRulesRequest, ModifyDefaultCertificateRequest, DeleteApplicationProxyResponse, ModifyAlarmDefaultThresholdResponse, CreateCredentialRequest, ModifyRuleRequest, DescribePrefetchTasksResponse, DescribeWebManagedRulesHitRuleDetailRequest, DescribeBotClientIpListResponse, ModifySecurityWafGroupPolicyRequest, DescribeZoneSettingRequest, ModifySecurityPolicyRequest, ModifyDnssecRequest, CreateApplicationProxyResponse, CreateIpTableListRequest, ModifyDDoSPolicyHostRequest, DeleteAliasDomainRequest, DescribeIdentificationsResponse, CreatePurgeTaskResponse, DeleteApplicationProxyRuleResponse, ReclaimAliasDomainRequest, CreateSecurityDropPageRequest, DeleteOriginGroupRequest, CreateLogTopicTaskResponse, DescribeDnsDataResponse, DescribeDDoSAttackSourceEventRequest, SwitchLogTopicTaskResponse, DescribeZonesRequest, DeleteLogTopicTaskRequest, CreatePrefetchTaskResponse, DescribeDefaultCertificatesRequest, ModifyApplicationProxyRuleResponse, DescribeWebProtectionHitRuleDetailRequest, DescribeSecurityRuleIdRequest, DownloadL7LogsRequest, DescribeAddableEntityListResponse, DescribeBotHitRuleDetailRequest, DescribeWebProtectionHitRuleDetailResponse, DescribeSpeedTestingMetricDataRequest, ModifyLogTopicTaskResponse, DescribeOverviewL7DataResponse, DescribeSecurityPolicyRequest, CreatePlanForZoneRequest, DownloadL4LogsResponse, DeleteOriginGroupResponse, CreateSecurityDropPageResponse, UpdateOriginProtectionIPWhitelistResponse, DescribeIdentificationsRequest, ModifyHostsCertificateResponse, CreateLogSetRequest, CreateIpTableListResponse, DescribeZoneSettingResponse, DescribePurgeTasksRequest, IdentifyZoneRequest, ModifyDDoSPolicyResponse, DescribeZoneDDoSPolicyRequest, ModifyLogTopicTaskRequest, DescribeDDoSAttackEventRequest, DescribeWebProtectionClientIpListRequest, ModifyDnssecResponse, CreateSpeedTestingResponse, DescribeOriginGroupRequest, DescribeLogTopicTasksResponse, CreatePlanForZoneResponse, DescribeLogTopicTasksRequest, DescribeDDoSAttackEventDetailResponse, CreateCredentialResponse, DescribeAliasDomainsRequest, SwitchLogTopicTaskRequest, DeleteApplicationProxyRequest, ModifyZoneStatusRequest, ModifyOriginGroupResponse, ModifyAliasDomainRequest, DescribeSecurityPortraitRulesRequest, DescribeSecurityPolicyRegionsResponse, DescribeBotTopDataRequest, DeleteZoneResponse, ReclaimZoneResponse, BindZoneToPlanResponse, ModifyApplicationProxyRequest, ModifyAliasDomainStatusRequest, ModifyAlarmDefaultThresholdRequest, ModifyApplicationProxyRuleRequest, DescribeSpeedTestingDetailsResponse, CreateAliasDomainResponse, DeleteApplicationProxyRuleRequest, DescribeDDoSBlockListResponse, DescribeTopL7CacheDataResponse, DescribeDnssecRequest, ModifyAlarmConfigResponse, ModifyAliasDomainStatusResponse, DescribeTimingL4AccessDataRequest, DescribeTimingL7AnalysisDataRequest, DescribeSecurityGroupManagedRulesRequest, ModifyApplicationProxyStatusRequest, CreateZoneRequest, DescribeLogSetsResponse, DescribeClientRuleListResponse, DescribeLogTopicTaskDetailRequest, CreateSpeedTestingRequest, CreateReplayTaskRequest, DescribeRateLimitIntelligenceRuleRequest, DescribeDDoSAttackDataRequest, DescribeWebManagedRulesDataResponse, DescribeApplicationProxiesRequest, DescribeContentQuotaRequest, DescribeWebProtectionAttackEventsRequest, CreateRuleRequest, DescribeRateLimitIntelligenceRuleResponse, CreateApplicationProxyRuleResponse, DescribeLogSetsRequest, CreateApplicationProxyRequest, DescribeTimingL4DataResponse, ModifyApplicationProxyResponse, ModifyApplicationProxyRuleStatusRequest, ModifyDefaultCertificateResponse, DescribeSecurityGroupManagedRulesResponse, DescribeSpeedTestingDetailsRequest, CreateLogTopicTaskRequest, ModifyAliasDomainResponse, DescribeBotLogRequest, ModifyHostsCertificateRequest, DescribeTopL7AnalysisDataResponse, DescribeOriginProtectionRequest, DescribeHostsSettingRequest, DescribeBotHitRuleDetailResponse, DescribeDDoSAttackEventDetailRequest, DeleteRulesResponse, DescribeWebManagedRulesHitRuleDetailResponse, ReclaimAliasDomainResponse, DeleteAliasDomainResponse, CreateReplayTaskResponse, DescribeTopL7CacheDataRequest, DescribeDistributionL4AccessDataResponse, DescribeBotManagedRulesResponse, CreateCustomErrorPageResponse, DescribeDDoSAttackDataResponse, ModifyApplicationProxyRuleStatusResponse, DescribeClientRuleListRequest, ModifyZoneRequest, DescribeAvailablePlansRequest, CreateRuleResponse, ModifyZoneResponse, DescribeBotTopDataResponse, DescribeBotClientIpListRequest, DescribeDDoSAttackTopDataRequest, DescribeRulesRequest, DescribeDDoSMajorAttackEventResponse, DescribeContentQuotaResponse, ModifyZoneSettingResponse, DownloadL7LogsResponse, DescribeWebManagedRulesLogResponse, DescribeOverviewL7DataRequest, DescribeWebProtectionTopDataRequest, ModifySecurityWafGroupPolicyResponse, DescribeWebManagedRulesDataRequest, DescribePrefetchTasksRequest, ModifyRulePriorityRequest, BindZoneToPlanRequest, ModifyRuleResponse, CheckCertificateResponse, DescribeWebProtectionDataRequest, DescribeSecurityPortraitRulesResponse, ModifyDDoSPolicyRequest, ModifyApplicationProxyStatusResponse, ModifyAlarmConfigRequest, UpdateOriginProtectionIPWhitelistRequest, DeleteLogTopicTaskResponse, DescribeRulesSettingResponse, CreateZoneResponse, DescribeSpeedTestingQuotaRequest, ModifySecurityPolicyResponse, ModifyOriginGroupRequest, DescribeAddableEntityListRequest, DescribeSingleL7AnalysisDataResponse, DescribeTimingL4AccessDataResponse, DescribeDefaultCertificatesResponse, CreateOriginGroupResponse, DescribeSecurityPolicyResponse, DescribeSecurityPolicyRegionsRequest, DescribeWebProtectionDataResponse, DescribeZoneDDoSPolicyResponse, ModifyZoneStatusResponse, DescribeWebProtectionAttackEventsResponse, CreatePurgeTaskRequest, DescribeSecurityRuleIdResponse, DescribePurgeTasksResponse, DescribeBotLogResponse, DescribeTimingL4DataRequest, DescribeBotManagedRulesRequest } from "./teo_models";
/**
 * teo client
 * @class
 */
export declare class Client extends AbstractClient {
     ...
     */
    DescribeTimingL4AccessData(req: DescribeTimingL4AccessDataRequest, cb?: (error: string, rep: DescribeTimingL4AccessDataResponse) => void): Promise<DescribeTimingL4AccessDataResponse>;
    /**
     * 用于验证站点所有权。
     */
     ...
     */
    DescribeDistributionL4AccessData(req: DescribeDistributionL4AccessDataRequest, cb?: (error: string, rep: DescribeDistributionL4AccessDataResponse) => void): Promise<DescribeDistributionL4AccessDataResponse>;
    /**
     * 创建自定义规则的自定义页
     */
