...
import { EnableVpcCniNetworkTypeRequest, DescribeClusterEndpointVipStatusRequest, CreateEKSContainerInstancesResponse, DescribeClusterSecurityResponse, DescribeClusterSecurityRequest, ModifyPrometheusAlertRuleRequest, DeleteClusterInstancesResponse, ModifyNodePoolDesiredCapacityAboutAsgResponse, ModifyClusterNodePoolResponse, DescribeClusterKubeconfigResponse, RemoveNodeFromNodePoolResponse, CreateClusterRouteRequest, DescribeClusterEndpointVipStatusResponse, ModifyClusterEndpointSPRequest, DescribeClusterInstancesResponse, DeleteClusterResponse, CreatePrometheusAlertRuleRequest, UpdateEKSClusterRequest, CreateClusterRouteTableResponse, DescribeClusterCommonNamesRequest, DeleteClusterEndpointResponse, CreatePrometheusTemplateRequest, RestartEKSContainerInstancesRequest, DescribeExternalClusterSpecRequest, DeletePrometheusTemplateRequest, DescribeEKSContainerInstanceRegionsRequest, DescribeEKSClustersResponse, DeleteClusterRequest, CreateEKSClusterRequest, DeleteClusterAsGroupsRequest, DescribeClusterControllersResponse, DescribeExistedInstancesRequest, DescribeRegionsResponse, CreateClusterRouteResponse, DescribePrometheusTemplatesRequest, ModifyPrometheusAlertRuleResponse, AddNodeToNodePoolRequest, DescribeEKSContainerInstanceEventResponse, DescribePrometheusAlertRuleResponse, DescribeVpcCniPodLimitsResponse, DescribeVersionsResponse, CreateClusterNodePoolFromExistingAsgRequest, DescribePrometheusAgentInstancesRequest, DescribeImagesResponse, ModifyClusterAttributeRequest, DeleteClusterRouteResponse, ModifyClusterEndpointSPResponse, CreateClusterEndpointVipResponse, DescribeClustersRequest, ModifyClusterAttributeResponse, DeletePrometheusAlertRuleRequest, DescribePrometheusTemplateSyncResponse, DescribePrometheusAlertHistoryRequest, DeletePrometheusTemplateSyncRequest, SetNodePoolNodeProtectionResponse, DisableVpcCniNetworkTypeRequest, AddVpcCniSubnetsRequest, DeleteClusterEndpointVipResponse, SyncPrometheusTemplateRequest, CreatePrometheusDashboardResponse, DescribeEKSClusterCredentialResponse, DeleteClusterInstancesRequest, ModifyClusterAsGroupAttributeResponse, CreateClusterInstancesRequest, DescribeEksContainerInstanceLogResponse, DeleteEKSClusterResponse, DescribePrometheusTemplatesResponse, DeleteClusterNodePoolRequest, DisableVpcCniNetworkTypeResponse, DescribeClusterKubeconfigRequest, CreatePrometheusTemplateResponse, CreateClusterEndpointVipRequest, EnableVpcCniNetworkTypeResponse, CheckInstancesUpgradeAbleRequest, ModifyNodePoolInstanceTypesRequest, AddClusterCIDRRequest, DeleteEKSContainerInstancesResponse, DescribePrometheusAlertRuleRequest, DescribeEKSClusterCredentialRequest, GetUpgradeInstanceProgressRequest, ModifyPrometheusTemplateRequest, DescribeExternalClusterSpecResponse, AddNodeToNodePoolResponse, UpdateEKSClusterResponse, DescribeRegionsRequest, UpdateEKSContainerInstanceRequest, DescribeClustersResponse, DescribeVpcCniPodLimitsRequest, DescribePrometheusOverviewsRequest, DescribeRouteTableConflictsRequest, SyncPrometheusTemplateResponse, DeleteEKSClusterRequest, GetUpgradeInstanceProgressResponse, DescribeExistedInstancesResponse, CreateEKSClusterResponse, DescribeEKSClustersRequest, CreatePrometheusAlertRuleResponse, UpdateEKSContainerInstanceResponse, ModifyNodePoolInstanceTypesResponse, CreateClusterNodePoolFromExistingAsgResponse, DescribeEnableVpcCniProgressRequest, DescribeClusterEndpointStatusRequest, CreateClusterAsGroupRequest, DescribeClusterNodePoolsResponse, DescribeRouteTableConflictsResponse, DescribeVersionsRequest, CreateClusterResponse, DescribeClusterRoutesResponse, DescribeEKSContainerInstancesResponse, DeleteClusterRouteTableRequest, DescribeAvailableClusterVersionRequest, CreateClusterRequest, DeletePrometheusAlertRuleResponse, UpgradeClusterInstancesRequest, AcquireClusterAdminRoleRequest, CreateClusterAsGroupResponse, DescribeEksContainerInstanceLogRequest, DeleteClusterAsGroupsResponse, DescribePrometheusInstanceRequest, DescribeClusterInstancesRequest, DescribePrometheusAgentsRequest, DescribeEnableVpcCniProgressResponse, AddClusterCIDRResponse, ModifyClusterNodePoolRequest, CreateClusterEndpointResponse, CreateClusterNodePoolRequest, AcquireClusterAdminRoleResponse, RestartEKSContainerInstancesResponse, ModifyPrometheusTemplateResponse, DeletePrometheusTemplateResponse, DescribePrometheusTemplateSyncRequest, UpdateClusterVersionRequest, DeleteClusterEndpointVipRequest, CheckInstancesUpgradeAbleResponse, DescribeClusterEndpointStatusResponse, UpgradeClusterInstancesResponse, CreatePrometheusDashboardRequest, DescribePrometheusAgentsResponse, AddExistedInstancesResponse, DeleteClusterRouteTableResponse, CreateClusterInstancesResponse, DescribeClusterAsGroupOptionRequest, DescribePrometheusAgentInstancesResponse, CreateClusterEndpointRequest, DescribeEKSContainerInstanceRegionsResponse, ModifyClusterAsGroupOptionAttributeResponse, DescribePrometheusInstanceResponse, AddExistedInstancesRequest, AddVpcCniSubnetsResponse, ModifyNodePoolDesiredCapacityAboutAsgRequest, DescribeClusterNodePoolsRequest, DescribeClusterRouteTablesRequest, ModifyClusterAsGroupOptionAttributeRequest, DescribeClusterRoutesRequest, DeleteClusterRouteRequest, DescribePrometheusOverviewsResponse, DeleteClusterEndpointRequest, DescribePrometheusTargetsRequest, DescribePrometheusTargetsResponse, DescribeClusterNodePoolDetailRequest, SetNodePoolNodeProtectionRequest, DeletePrometheusTemplateSyncResponse, CreateClusterRouteTableRequest, DescribeClusterAsGroupsRequest, DescribeImagesRequest, DescribeAvailableClusterVersionResponse, DescribeClusterRouteTablesResponse, DeleteEKSContainerInstancesRequest, DescribePrometheusAlertHistoryResponse, DescribeClusterCommonNamesResponse, DescribeClusterAsGroupOptionResponse, DeleteClusterNodePoolResponse, UpdateClusterVersionResponse, CreateEKSContainerInstancesRequest, CreateClusterNodePoolResponse, ModifyClusterAsGroupAttributeRequest, RemoveNodeFromNodePoolRequest, DescribeClusterAsGroupsResponse, DescribeEKSContainerInstancesRequest, DescribeClusterNodePoolDetailResponse, DescribeClusterControllersRequest, DescribeEKSContainerInstanceEventRequest } from "./tke_models";
/**
 * tke client
 * @class
 */
