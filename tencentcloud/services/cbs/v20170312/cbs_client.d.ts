...
import { ModifyDiskExtraPerformanceRequest, RenewDiskRequest, AttachDisksResponse, DescribeSnapshotOperationLogsRequest, ModifyAutoSnapshotPolicyAttributeResponse, InquiryPriceCreateDisksResponse, BindAutoSnapshotPolicyRequest, CreateSnapshotResponse, DescribeAutoSnapshotPoliciesRequest, ModifySnapshotsSharePermissionResponse, DescribeDiskStoragePoolRequest, ModifyDiskAttributesResponse, InquirePriceModifyDiskExtraPerformanceResponse, CreateDisksRequest, AttachDisksRequest, DescribeDiskAssociatedAutoSnapshotPolicyRequest, DescribeSnapshotsRequest, TerminateDisksResponse, DescribeDiskConfigQuotaResponse, InquiryPriceResizeDiskResponse, ResizeDiskResponse, ModifyAutoSnapshotPolicyAttributeRequest, DetachDisksRequest, ModifyDisksChargeTypeResponse, CreateSnapshotRequest, DescribeInstancesDiskNumRequest, DescribeSnapshotSharePermissionResponse, InquiryPriceRenewDisksRequest, DescribeSnapshotSharePermissionRequest, DescribeSnapshotOperationLogsResponse, DeleteSnapshotsRequest, ModifyDisksRenewFlagResponse, DeleteAutoSnapshotPoliciesResponse, DescribeDisksResponse, DeleteSnapshotsResponse, ModifyDisksRenewFlagRequest, ModifyDiskAttributesRequest, GetSnapOverviewRequest, TerminateDisksRequest, DescribeInstancesDiskNumResponse, DescribeDiskOperationLogsResponse, ResizeDiskRequest, ModifyDisksChargeTypeRequest, CreateAutoSnapshotPolicyResponse, ModifySnapshotAttributeRequest, UnbindAutoSnapshotPolicyRequest, DeleteAutoSnapshotPoliciesRequest, InquiryPriceCreateDisksRequest, DescribeSnapshotsResponse, CreateDisksResponse, ModifySnapshotsSharePermissionRequest, BindAutoSnapshotPolicyResponse, DescribeDiskOperationLogsRequest, DescribeDisksRequest, DetachDisksResponse, InquiryPriceRenewDisksResponse, DescribeDiskStoragePoolResponse, InquirePriceModifyDiskExtraPerformanceRequest, InquiryPriceResizeDiskRequest, DescribeDiskConfigQuotaRequest, DescribeDiskAssociatedAutoSnapshotPolicyResponse, GetSnapOverviewResponse, ApplySnapshotResponse, ModifySnapshotAttributeResponse, RenewDiskResponse, DescribeAutoSnapshotPoliciesResponse, UnbindAutoSnapshotPolicyResponse, CreateAutoSnapshotPolicyRequest, ModifyDiskExtraPerformanceResponse, ApplySnapshotRequest } from "./cbs_models";
/**
 * cbs client
 * @class
 */
