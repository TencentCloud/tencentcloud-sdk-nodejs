...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    deserialize(params) {
        ...
        if (params.ImageTaskData) {
            let obj = new ImageData();
            obj.deserialize(params.ImageTaskData)
            this.ImageTaskData = obj;
        }

        if (params.AudioTaskData) {
            let obj = new AudioData();
            obj.deserialize(params.AudioTaskData)
            this.AudioTaskData = obj;
        }

        if (params.TextTaskData) {
            let obj = new TextData();
            obj.deserialize(params.TextTaskData)
            this.TextTaskData = obj;
        }
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    deserialize(params) {
        ...
        if (params.AudioMetadata) {
            let obj = new AudioMetadata();
            obj.deserialize(params.AudioMetadata)
            this.AudioMetadata = obj;
        }

        if (params.ImageMetadata) {
            let obj = new ImageMetadata();
            obj.deserialize(params.ImageMetadata)
            this.ImageMetadata = obj;
        }

        if (params.TextMetadata) {
            let obj = new TextMetadata();
            obj.deserialize(params.TextMetadata)
            this.TextMetadata = obj;
        }
...
注意：此字段可能返回 null，表示取不到有效值。
         ...
         * 未知人物信息
注意：此字段可能返回 null，表示取不到有效值。
         * @type {Array.<UnknownPerson> || null}
         */
        this.UnknownPersonSet = null;

        /**
         * 树状已分类人物信息
注意：此字段可能返回 null，表示取不到有效值。
         * @type {Array.<MultiLevelPersonInfo> || null}
         */
        this.MultiLevelPersonInfoSet = null;
    ...
    deserialize(params) {
        ...
        if (params.UnknownPersonSet) {
            this.UnknownPersonSet = new Array();
            for (let z in params.UnknownPersonSet) {
                let obj = new UnknownPerson();
                obj.deserialize(params.UnknownPersonSet[z]);
                this.UnknownPersonSet.push(obj);
            }
        }

        if (params.MultiLevelPersonInfoSet) {
            this.MultiLevelPersonInfoSet = new Array();
            for (let z in params.MultiLevelPersonInfoSet) {
                let obj = new MultiLevelPersonInfo();
                obj.deserialize(params.MultiLevelPersonInfoSet[z]);
                this.MultiLevelPersonInfoSet.push(obj);
            }
        }
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    deserialize(params) {
        ...
        if (params.AppearRect) {
            let obj = new Rectf();
            obj.deserialize(params.AppearRect)
            this.AppearRect = obj;
        }
...
注意：此字段可能返回 null，表示取不到有效值。
         * @type {Array.<ClassifiedPersonInfo> || null}
         */
        this.L2ClassifiedPersonInfoSet = null;
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    deserialize(params) {
        ...
        this.L1ClassifyName = 'L1ClassifyName' in params ? params.L1ClassifyName : null;

        if (params.L2ClassifiedPersonInfoSet) {
            this.L2ClassifiedPersonInfoSet = new Array();
            for (let z in params.L2ClassifiedPersonInfoSet) {
                let obj = new ClassifiedPersonInfo();
                obj.deserialize(params.L2ClassifiedPersonInfoSet[z]);
                this.L2ClassifiedPersonInfoSet.push(obj);
            }
        }
        this.Source = 'Source' in params ? params.Source : null;
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    deserialize(params) {
        ...
        this.PutLibraryAllowed = 'PutLibraryAllowed' in params ? params.PutLibraryAllowed : null;
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    deserialize(params) {
        ...
        if (params.OcrSet) {
            this.OcrSet = new Array();
            for (let z in params.OcrSet) {
                let obj = new ImageOcr();
                obj.deserialize(params.OcrSet[z]);
                this.OcrSet.push(obj);
            }
        }
        ...
        if (params.TvLogo) {
            let obj = new ImageLogo();
            obj.deserialize(params.TvLogo)
            this.TvLogo = obj;
        }

        if (params.SourceLogo) {
            let obj = new ImageLogo();
            obj.deserialize(params.SourceLogo)
            this.SourceLogo = obj;
        }
