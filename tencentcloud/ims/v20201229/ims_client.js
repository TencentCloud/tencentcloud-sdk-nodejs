...
const CreateImageModerationAsyncTaskResponse = models.CreateImageModerationAsyncTaskResponse;
...
const CreateImageModerationAsyncTaskRequest = models.CreateImageModerationAsyncTaskRequest;
...
- 默认接口请求频率限制：**20次/秒**，超过此调用频率则会报错。
     * @param {CreateImageModerationAsyncTaskRequest} req
     * @param {function(string, CreateImageModerationAsyncTaskResponse):void} cb
     * @public
     */
    CreateImageModerationAsyncTask(req, cb) {
        let resp = new CreateImageModerationAsyncTaskResponse();
        this.request("CreateImageModerationAsyncTask", req, resp, cb);
    }
