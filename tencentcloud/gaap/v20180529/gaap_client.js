...
const CreateFirstLinkSessionRequest = models.CreateFirstLinkSessionRequest;
...
const CreateFirstLinkSessionResponse = models.CreateFirstLinkSessionResponse;
...
注意：本接口会解绑之前绑定的源站，绑定本次调用所选择的源站。例如：原来绑定的源站为A，B，C，本次调用的选择绑定的源站为C，D，E，那么调用后所绑定的源站为C，D，E。
     ...
     * @param {CreateFirstLinkSessionRequest} req
     * @param {function(string, CreateFirstLinkSessionResponse):void} cb
     * @public
     */
    CreateFirstLinkSession(req, cb) {
        let resp = new CreateFirstLinkSessionResponse();
        this.request("CreateFirstLinkSession", req, resp, cb);
    }
...
该接口仅支持version3.0的通道。
     ...
     * @param {DescribeFirstLinkSessionRequest} req
     * @param {function(string, DescribeFirstLinkSessionResponse):void} cb
     * @public
     */
    DescribeFirstLinkSession(req, cb) {
        let resp = new DescribeFirstLinkSessionResponse();
        this.request("DescribeFirstLinkSession", req, resp, cb);
    }

    /**
     * 本接口（DeleteFirstLinkSession）用于删除接入段加速会话，删除加速会话后会停止加速。
     * @param {DeleteFirstLinkSessionRequest} req
     * @param {function(string, DeleteFirstLinkSessionResponse):void} cb
     * @public
     */
    DeleteFirstLinkSession(req, cb) {
        let resp = new DeleteFirstLinkSessionResponse();
        this.request("DeleteFirstLinkSession", req, resp, cb);
    }
