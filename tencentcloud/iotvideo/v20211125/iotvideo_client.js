...
const PackageConsumeStat = models.PackageConsumeStat;
const DescribeCloudStoragePackageConsumeDetailsResponse = models.DescribeCloudStoragePackageConsumeDetailsResponse;
const CreateCloudStorageRequest = models.CreateCloudStorageRequest;
const MessageCntStats = models.MessageCntStats;
const DescribeDeviceDataStatsRequest = models.DescribeDeviceDataStatsRequest;
...
const DescribePackageConsumeTaskRequest = models.DescribePackageConsumeTaskRequest;
...
const DescribeMessageDataStatsResponse = models.DescribeMessageDataStatsResponse;
...
const DescribeCloudStoragePackageConsumeStatsResponse = models.DescribeCloudStoragePackageConsumeStatsResponse;
...
const DescribeBonusesResponse = models.DescribeBonusesResponse;
...
const PackageConsumeTask = models.PackageConsumeTask;
...
const DescribePushChannelResponse = models.DescribePushChannelResponse;
...
const BonusInfo = models.BonusInfo;
...
const DescribePackageConsumeTasksResponse = models.DescribePackageConsumeTasksResponse;
...
const DescribeCloudStorageStreamDataResponse = models.DescribeCloudStorageStreamDataResponse;
...
const ModifyPushChannelResponse = models.ModifyPushChannelResponse;
...
const DescribePackageConsumeTaskResponse = models.DescribePackageConsumeTaskResponse;
...
const DescribePackageConsumeTasksRequest = models.DescribePackageConsumeTasksRequest;
const DescribeAccountRequest = models.DescribeAccountRequest;
...
const DescribeCloudStoragePackageConsumeStatsRequest = models.DescribeCloudStoragePackageConsumeStatsRequest;
...
const ModifyPushChannelRequest = models.ModifyPushChannelRequest;
...
const DescribeCloudStoragePackageConsumeDetailsRequest = models.DescribeCloudStoragePackageConsumeDetailsRequest;
...
const DescribeDeviceDataStatsResponse = models.DescribeDeviceDataStatsResponse;
const DescribeAccountResponse = models.DescribeAccountResponse;
const DescribePushChannelRequest = models.DescribePushChannelRequest;
const DescribeCloudStorageThumbnailRequest = models.DescribeCloudStorageThumbnailRequest;
const DescribeMessageDataStatsRequest = models.DescribeMessageDataStatsRequest;
...
const DescribeCloudStorageStreamDataRequest = models.DescribeCloudStorageStreamDataRequest;
...
const DescribeBonusesRequest = models.DescribeBonusesRequest;
...
const DeviceCntStats = models.DeviceCntStats;
...
class IotvideoClient extends AbstractClient {
    ...
    constructor(credential, region, profile) {
        super("iotvideo.tencentcloudapi.com", "2021-11-25", credential, region, profile);
    }
    ...
    /**
     * 更新推送通道
     * @param {ModifyPushChannelRequest} req
     * @param {function(string, ModifyPushChannelResponse):void} cb
     * @public
     */
    ModifyPushChannel(req, cb) {
        let resp = new ModifyPushChannelResponse();
        this.request("ModifyPushChannel", req, resp, cb);
    }
    ...
    /**
     * 查询套餐消耗记录列表
     * @param {DescribePackageConsumeTasksRequest} req
     * @param {function(string, DescribePackageConsumeTasksResponse):void} cb
     * @public
     */
    DescribePackageConsumeTasks(req, cb) {
        let resp = new DescribePackageConsumeTasksResponse();
        this.request("DescribePackageConsumeTasks", req, resp, cb);
    }

    /**
     * 获取消费版账号信息
     * @param {DescribeAccountRequest} req
     * @param {function(string, DescribeAccountResponse):void} cb
     * @public
     */
    DescribeAccount(req, cb) {
        let resp = new DescribeAccountResponse();
        this.request("DescribeAccount", req, resp, cb);
    }

    /**
     * 获取云存套餐包消耗统计
     * @param {DescribeCloudStoragePackageConsumeStatsRequest} req
     * @param {function(string, DescribeCloudStoragePackageConsumeStatsResponse):void} cb
     * @public
     */
    DescribeCloudStoragePackageConsumeStats(req, cb) {
        let resp = new DescribeCloudStoragePackageConsumeStatsResponse();
        this.request("DescribeCloudStoragePackageConsumeStats", req, resp, cb);
    }
    ...
    /**
     * 查看推送通道
     * @param {DescribePushChannelRequest} req
     * @param {function(string, DescribePushChannelResponse):void} cb
     * @public
     */
    DescribePushChannel(req, cb) {
        let resp = new DescribePushChannelResponse();
        this.request("DescribePushChannel", req, resp, cb);
    }
    ...
    /**
     * 查询设备数据统计
     * @param {DescribeDeviceDataStatsRequest} req
     * @param {function(string, DescribeDeviceDataStatsResponse):void} cb
     * @public
     */
    DescribeDeviceDataStats(req, cb) {
        let resp = new DescribeDeviceDataStatsResponse();
        this.request("DescribeDeviceDataStats", req, resp, cb);
    }
    ...
    /**
     * 查询设备消息数量统计
     * @param {DescribeMessageDataStatsRequest} req
     * @param {function(string, DescribeMessageDataStatsResponse):void} cb
     * @public
     */
    DescribeMessageDataStats(req, cb) {
        let resp = new DescribeMessageDataStatsResponse();
        this.request("DescribeMessageDataStats", req, resp, cb);
    }
    ...
    /**
     * 查询套餐消耗记录详情
     * @param {DescribePackageConsumeTaskRequest} req
     * @param {function(string, DescribePackageConsumeTaskResponse):void} cb
     * @public
     */
    DescribePackageConsumeTask(req, cb) {
        let resp = new DescribePackageConsumeTaskResponse();
        this.request("DescribePackageConsumeTask", req, resp, cb);
    }
    ...
    /**
     * 获取设备图片流数据
     * @param {DescribeCloudStorageStreamDataRequest} req
     * @param {function(string, DescribeCloudStorageStreamDataResponse):void} cb
     * @public
     */
    DescribeCloudStorageStreamData(req, cb) {
        let resp = new DescribeCloudStorageStreamDataResponse();
        this.request("DescribeCloudStorageStreamData", req, resp, cb);
    }
    ...
    /**
     * 查看运营活动资源包列表
     * @param {DescribeBonusesRequest} req
     * @param {function(string, DescribeBonusesResponse):void} cb
     * @public
     */
    DescribeBonuses(req, cb) {
        let resp = new DescribeBonusesResponse();
        this.request("DescribeBonuses", req, resp, cb);
    }
    ...
    /**
     * 获取云存套餐包消耗详细记录
     * @param {DescribeCloudStoragePackageConsumeDetailsRequest} req
     * @param {function(string, DescribeCloudStoragePackageConsumeDetailsResponse):void} cb
     * @public
     */
    DescribeCloudStoragePackageConsumeDetails(req, cb) {
        let resp = new DescribeCloudStoragePackageConsumeDetailsResponse();
        this.request("DescribeCloudStoragePackageConsumeDetails", req, resp, cb);
    }
