 ...
 * @class
 */
class DescribeCloudStoragePackageConsumeDetailsResponse extends  AbstractModel {
    constructor(){
        super();
...
lye1y30d：低功耗事件30天年套餐。
    ...
    deserialize(params) {
        ...
        this.PackageQueue = 'PackageQueue' in params ? params.PackageQueue : null;
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    deserialize(params) {
        ...
        this.UpMsgCnt = 'UpMsgCnt' in params ? params.UpMsgCnt : null;
        this.DownMsgCnt = 'DownMsgCnt' in params ? params.DownMsgCnt : null;
        this.NtpMsgCnt = 'NtpMsgCnt' in params ? params.NtpMsgCnt : null;
 ...
 * @class
 */
class DescribeDeviceDataStatsRequest extends  AbstractModel {
    constructor(){
        super();
 ...
 * @class
 */
class DescribePackageConsumeTaskRequest extends  AbstractModel {
    constructor(){
        super();
 ...
 * @class
 */
class DescribeMessageDataStatsResponse extends  AbstractModel {
    constructor(){
        super();
         ...
         * 消息数量列表
注意：此字段可能返回 null，表示取不到有效值。
         * @type {Array.<MessageCntStats> || null}
         */
        this.Data = null;
 ...
 * @class
 */
class DescribeCloudStoragePackageConsumeStatsResponse extends  AbstractModel {
    constructor(){
        super();

        /**
         * 统计列表详情
         * @type {Array.<PackageConsumeStat> || null}
         */
        this.Stats = null;
    ...
    deserialize(params) {
        ...
        if (params.Stats) {
            ...
            for (let z in params.Stats) {
                let obj = new PackageConsumeStat();
                obj.deserialize(params.Stats[z]);
                this.Stats.push(obj);
            }
        }
        this.RequestId = 'RequestId' in params ? params.RequestId : null;
 ...
 * @class
 */
class DescribeBonusesResponse extends  AbstractModel {
    constructor(){
        super();
    ...
    deserialize(params) {
        ...
        if (params.Bonuses) {
            ...
            for (let z in params.Bonuses) {
                let obj = new BonusInfo();
                obj.deserialize(params.Bonuses[z]);
 ...
 * @class
 */
class DescribePushChannelResponse extends  AbstractModel {
    constructor(){
        super();
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    deserialize(params) {
        ...
        this.BonusId = 'BonusId' in params ? params.BonusId : null;
        this.UserId = 'UserId' in params ? params.UserId : null;
        this.PackageId = 'PackageId' in params ? params.PackageId : null;
        this.Total = 'Total' in params ? params.Total : null;
 ...
 * @class
 */
class DescribePackageConsumeTasksResponse extends  AbstractModel {
    constructor(){
        super();
        ...
        /**
         * 任务列表
         * @type {Array.<PackageConsumeTask> || null}
         */
        this.List = null;
    ...
    deserialize(params) {
        ...
        if (params.List) {
            ...
            for (let z in params.List) {
                let obj = new PackageConsumeTask();
...
class DescribeCloudStorageStreamDataResponse extends  AbstractModel {
    ...
    deserialize(params) {
        ...
        this.VideoStream = 'VideoStream' in params ? params.VideoStream : null;
        this.AudioStream = 'AudioStream' in params ? params.AudioStream : null;
        this.RequestId = 'RequestId' in params ? params.RequestId : null;
 ...
 * @class
 */
class ModifyPushChannelResponse extends  AbstractModel {
    constructor(){
        super();
 ...
 * @class
 */
class DescribePackageConsumeTaskResponse extends  AbstractModel {
    constructor(){
        super();
 ...
 * @class
 */
class DescribeAccountRequest extends  AbstractModel {
    constructor(){
        super();
 ...
 * @class
 */
class DescribeDeviceDataStatsResponse extends  AbstractModel {
    constructor(){
        super();
...
注意：此字段可能返回 null，表示取不到有效值。
         * @type {number || null}
         */
        this.RegisterCnt = null;

        /**
         * 设备数量列表
注意：此字段可能返回 null，表示取不到有效值。
         * @type {Array.<DeviceCntStats> || null}
         */
        this.Data = null;
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    deserialize(params) {
        ...
        this.RegisterCnt = 'RegisterCnt' in params ? params.RegisterCnt : null;

        if (params.Data) {
            this.Data = new Array();
            for (let z in params.Data) {
                let obj = new DeviceCntStats();
                obj.deserialize(params.Data[z]);
                this.Data.push(obj);
            }
        }
...
class DescribeAccountResponse extends  AbstractModel {
    ...
    deserialize(params) {
        ...
        this.BillMode = 'BillMode' in params ? params.BillMode : null;
        this.RequestId = 'RequestId' in params ? params.RequestId : null;
 ...
 * @class
 */
class DescribePushChannelRequest extends  AbstractModel {
    constructor(){
        super();
 ...
 * @class
 */
class DescribeCloudStorageStreamDataRequest extends  AbstractModel {
    constructor(){
        super();
...
class TransferCloudStorageRequest extends  AbstractModel {
    ...
    deserialize(params) {
        ...
        this.ToProductId = 'ToProductId' in params ? params.ToProductId : null;
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    deserialize(params) {
        ...
        this.Date = 'Date' in params ? params.Date : null;
        this.NewRegisterCnt = 'NewRegisterCnt' in params ? params.NewRegisterCnt : null;
        this.NewActivateCnt = 'NewActivateCnt' in params ? params.NewActivateCnt : null;
...
module.exports = {
    ...
    DescribePackageConsumeTaskRequest: DescribePackageConsumeTaskRequest,
    ...
    DescribeMessageDataStatsResponse: DescribeMessageDataStatsResponse,
    ...
    DescribeBonusesResponse: DescribeBonusesResponse,
    ...
    DescribePackageConsumeTasksResponse: DescribePackageConsumeTasksResponse,
    ...
    DescribeCloudStorageStreamDataResponse: DescribeCloudStorageStreamDataResponse,
    ...
    DescribeDeviceDataStatsResponse: DescribeDeviceDataStatsResponse,
    DescribeAccountResponse: DescribeAccountResponse,
    DescribePushChannelRequest: DescribePushChannelRequest,
    DescribeCloudStorageThumbnailRequest: DescribeCloudStorageThumbnailRequest,
    DescribeMessageDataStatsRequest: DescribeMessageDataStatsRequest,
    ...
    DescribeBonusesRequest: DescribeBonusesRequest,
